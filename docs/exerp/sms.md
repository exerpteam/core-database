...
| `message_center` | Foreign key field linking this record to `messages`. | `int4` | Yes | No | [messages](messages.md) via (`message_center`, `message_id`, `message_sub_id` -> `center`, `id`, `subid`) | - |
| `message_id` | Foreign key field linking this record to `messages`. | `int4` | Yes | No | [messages](messages.md) via (`message_center`, `message_id`, `message_sub_id` -> `center`, `id`, `subid`) | - |
| `message_sub_id` | Foreign key field linking this record to `messages`. | `int4` | Yes | No | [messages](messages.md) via (`message_center`, `message_id`, `message_sub_id` -> `center`, `id`, `subid`) | - |
| `ack_code` | Text field containing descriptive or reference information. | `text(2147483647)` | Yes | No | - | - |
| `ack_text` | Text field containing descriptive or reference information. | `text(2147483647)` | Yes | No | - | - |
