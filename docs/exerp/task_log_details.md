...
| `task_log_id` | Foreign key field linking this record to `task_log`. | `int4` | Yes | No | [task_log](task_log.md) via (`task_log_id` -> `id`) | - | `1001` |
...
| `VALUE` | Text field containing descriptive or reference information. | `text(2147483647)` | Yes | No | - | - | `Sample value` |
