...
| `foreign_center_id` | Identifier for the related foreign center entity used by this record. | `int4` | No | No | - | - |
| `travel_time` | Timestamp value (epoch milliseconds) used for event ordering and incremental extraction. | `int4` | No | No | - | - |
