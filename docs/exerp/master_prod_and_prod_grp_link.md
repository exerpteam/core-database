...
| --- | --- | --- | --- | --- | --- | --- |
| `master_product_id` | Primary key component used to uniquely identify this record. | `int4` | No | Yes | [masterproductregister](masterproductregister.md) via (`master_product_id` -> `id`) | - |
