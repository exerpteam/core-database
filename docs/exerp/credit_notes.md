...
| `cashregister_center` | Foreign key field linking this record to `cashregisters`. | `int4` | Yes | No | [cashregisters](cashregisters.md) via (`cashregister_center`, `cashregister_id` -> `center`, `id`) | - | `101` |
| `cashregister_id` | Foreign key field linking this record to `cashregisters`. | `int4` | Yes | No | [cashregisters](cashregisters.md) via (`cashregister_center`, `cashregister_id` -> `center`, `id`) | - | `1001` |
| `paysessionid` | Numeric field used for identifiers, counters, or coded values. | `int4` | Yes | No | - | - | `42` |
...
| `payer_center` | Foreign key field linking this record to `persons`. | `int4` | Yes | No | [persons](persons.md) via (`payer_center`, `payer_id` -> `center`, `id`) | - | `101` |
| `payer_id` | Foreign key field linking this record to `persons`. | `int4` | Yes | No | [persons](persons.md) via (`payer_center`, `payer_id` -> `center`, `id`) | - | `1001` |
| `receipt_id` | Identifier of the related receipt record. | `int4` | Yes | No | - | - | `1001` |
...
| `control_code` | Text field containing descriptive or reference information. | `VARCHAR(500)` | Yes | No | - | - | `Sample value` |
...
| `auditedbycenter` | Foreign key field linking this record to `employees`. | `int4` | Yes | No | [employees](employees.md) via (`auditedbycenter`, `auditedbyid` -> `center`, `id`) | - | `42` |
| `auditedbyid` | Foreign key field linking this record to `employees`. | `int4` | Yes | No | [employees](employees.md) via (`auditedbycenter`, `auditedbyid` -> `center`, `id`) | - | `42` |
| `canceltype` | Numeric field used for identifiers, counters, or coded values. | `int4` | Yes | No | - | - | `42` |
...
| `clearance_status` | Text field containing descriptive or reference information. | `VARCHAR(20)` | No | No | - | - | `Sample value` |
