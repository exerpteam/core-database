...
| `parent_id` | Foreign key field linking this record to `postal_area`. | `int4` | Yes | No | [postal_area](postal_area.md) via (`parent_id` -> `id`) | - |
| `name` | Text field containing descriptive or reference information. | `VARCHAR(200)` | No | No | - | - |
| `alternative_name` | Text field containing descriptive or reference information. | `VARCHAR(200)` | Yes | No | - | - |
| `type` | Text field containing descriptive or reference information. | `VARCHAR(50)` | No | No | - | - |
