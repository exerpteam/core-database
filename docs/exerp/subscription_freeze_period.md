...
| `start_invoice_line_center` | Foreign key field linking this record to `invoice_lines_mt`. | `int4` | Yes | No | [invoice_lines_mt](invoice_lines_mt.md) via (`start_invoice_line_center`, `start_invoice_line_id`, `start_invoice_line_subid` -> `center`, `id`, `subid`) | - |
| `start_invoice_line_id` | Foreign key field linking this record to `invoice_lines_mt`. | `int4` | Yes | No | [invoice_lines_mt](invoice_lines_mt.md) via (`start_invoice_line_center`, `start_invoice_line_id`, `start_invoice_line_subid` -> `center`, `id`, `subid`) | - |
| `start_invoice_line_subid` | Foreign key field linking this record to `invoice_lines_mt`. | `int4` | Yes | No | [invoice_lines_mt](invoice_lines_mt.md) via (`start_invoice_line_center`, `start_invoice_line_id`, `start_invoice_line_subid` -> `center`, `id`, `subid`) | - |
...
| `entry_interface_type` | Numeric field used for identifiers, counters, or coded values. | `int4` | Yes | No | - | - |
...
| `cancel_interface_type` | Numeric field used for identifiers, counters, or coded values. | `int4` | Yes | No | - | - |
| `end_notified` | Boolean flag used in business rules and filtering logic. | `bool` | No | No | - | - |
