...
| `colour` | Text field containing descriptive or reference information. | `text(2147483647)` | Yes | No | - | - | `Sample value` |
| `old_colour_code_id` | Identifier of the related old colour code record. | `int4` | Yes | No | - | - | `1001` |
