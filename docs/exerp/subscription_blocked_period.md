...
| `main_reduced_period` | Identifier of the related subscription reduced period record used by this row. | `int4` | Yes | No | [subscription_reduced_period](subscription_reduced_period.md) via (`main_reduced_period` -> `id`) | - |
