...
| `supply_scope_type` | Text field containing descriptive or reference information. | `text(2147483647)` | No | No | - | - | `Sample value` |
| `supply_scope_id` | Identifier of the related supply scope record. | `int4` | No | No | - | - | `1001` |
| `delivery_time` | Epoch timestamp for delivery. | `text(2147483647)` | No | No | - | - | `Sample value` |
| `finance_account_globalid` | Text field containing descriptive or reference information. | `text(2147483647)` | No | No | - | - | `Sample value` |
