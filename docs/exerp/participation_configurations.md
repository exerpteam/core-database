...
| `ordinal` | Numeric field used for identifiers, counters, or coded values. | `int4` | No | No | - | - | `42` |
| `min_participants_at_creation` | Numeric field used for identifiers, counters, or coded values. | `int4` | No | No | - | - | `42` |
| `max_participants_at_creation` | Numeric field used for identifiers, counters, or coded values. | `int4` | Yes | No | - | - | `42` |
| `minimum_showups` | Numeric field used for identifiers, counters, or coded values. | `int4` | No | No | - | - | `42` |
| `max_participants_absolute` | Numeric field used for identifiers, counters, or coded values. | `int4` | Yes | No | - | - | `42` |
| `max_participants_percentage` | Numeric field used for identifiers, counters, or coded values. | `int4` | Yes | No | - | - | `42` |
| `access_group_id` | Foreign key field linking this record to `booking_privilege_groups`. | `int4` | Yes | No | [booking_privilege_groups](booking_privilege_groups.md) via (`access_group_id` -> `id`) | - | `1001` |
| `owner_participation` | Boolean flag used in business rules and filtering logic. | `bool` | No | No | - | - | `true` |
| `participate_in_all_recurring` | Boolean flag used in business rules and filtering logic. | `bool` | No | No | - | - | `true` |
| `privilege_at_showup_client` | Boolean flag used in business rules and filtering logic. | `bool` | No | No | - | - | `true` |
| `privilege_at_showup_kiosk` | Boolean flag used in business rules and filtering logic. | `bool` | No | No | - | - | `true` |
| `privilege_at_showup_web` | Boolean flag used in business rules and filtering logic. | `bool` | No | No | - | - | `true` |
