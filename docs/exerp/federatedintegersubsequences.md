...
| `seq` | Numeric field used for identifiers, counters, or coded values. | `int4` | No | Yes | - | - | `42` |
| `subname` | Text field containing descriptive or reference information. | `VARCHAR(32)` | No | Yes | - | - | `Example Name` |
| `allocincrement` | Numeric field used for identifiers, counters, or coded values. | `int4` | No | No | - | - | `42` |
| `nextsubseq` | Numeric field used for identifiers, counters, or coded values. | `int4` | No | No | - | - | `42` |
