...
| `device_id` | Foreign key field linking this record to `devices`. | `int4` | Yes | No | [devices](devices.md) via (`device_id` -> `id`) | - | `1001` |
| `device_sub_id` | Identifier of the related device sub record. | `text(2147483647)` | Yes | No | - | - | `1001` |
