...
| `cron_expression` | Text field containing descriptive or reference information. | `text(2147483647)` | No | No | - | - | `Sample value` |
| `time_zone_id` | Identifier of the related time zone record. | `text(2147483647)` | Yes | No | - | - | `1001` |
