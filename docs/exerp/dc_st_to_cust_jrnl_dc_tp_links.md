...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `documentation_setting_key` | Foreign key field linking this record to `documentation_settings`. | `int4` | No | Yes | [documentation_settings](documentation_settings.md) via (`documentation_setting_key` -> `id`) | - | `42` |
| `custom_journal_doc_type_key` | Foreign key field linking this record to `custom_journal_document_types`. | `int4` | No | Yes | [custom_journal_document_types](custom_journal_document_types.md) via (`custom_journal_doc_type_key` -> `id`) | - | `42` |
