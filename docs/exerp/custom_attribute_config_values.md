...
| `external_id` | External/business identifier used in integrations and exports. | `VARCHAR(100)` | No | No | - | - |
| `VALUE` | Text field containing descriptive or reference information. | `VARCHAR(4000)` | No | No | - | - |
