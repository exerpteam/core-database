...
| `invoice_payment_session_id` | Identifier of the related invoice payment session record. | `int4` | No | No | - | - |
| `transaction_reference` | Table field used by operational and reporting workloads. | `json` | No | No | - | - |
