...
| `idmethod` | Operational field `idmethod` used in query filtering and reporting transformations. | `int4` | No | No | - | - |
...
| `entitystatus` | State indicator used to control lifecycle transitions and filtering. | `int4` | No | No | - | - |
