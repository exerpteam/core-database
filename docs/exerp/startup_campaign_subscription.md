...
| `startup_campaign` | Foreign key field linking this record to `startup_campaign`. | `int4` | Yes | No | [startup_campaign](startup_campaign.md) via (`startup_campaign` -> `id`) | - | `42` |
