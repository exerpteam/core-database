...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `documentation_setting_id` | Foreign key field linking this record to `documentation_settings`. | `int4` | No | Yes | [documentation_settings](documentation_settings.md) via (`documentation_setting_id` -> `id`) | - | `1001` |
| `questionnaire_campaign_id` | Foreign key field linking this record to `questionnaire_campaigns`. | `int4` | No | Yes | [questionnaire_campaigns](questionnaire_campaigns.md) via (`questionnaire_campaign_id` -> `id`) | - | `1001` |
