...
| `ar_type` | Numeric field used for identifiers, counters, or coded values. | `int4` | No | No | - | - | `42` |
...
| `customercenter` | Foreign key field linking this record to `persons`. | `int4` | No | No | [persons](persons.md) via (`customercenter`, `customerid` -> `center`, `id`) | - | `42` |
| `customerid` | Foreign key field linking this record to `persons`. | `int4` | No | No | [persons](persons.md) via (`customercenter`, `customerid` -> `center`, `id`) | - | `42` |
| `debit_max` | Numeric field used for identifiers, counters, or coded values. | `NUMERIC(0,0)` | Yes | No | - | - | `99.95` |
...
| `balance` | Numeric field used for identifiers, counters, or coded values. | `NUMERIC(0,0)` | No | No | - | - | `99.95` |
| `last_entry_time` | Epoch timestamp for last entry. | `int8` | Yes | No | - | - | `1738281600000` |
| `last_trans_time` | Epoch timestamp for last trans. | `int8` | Yes | No | - | - | `1738281600000` |
| `STATE` | State code representing the current processing state. | `int4` | No | No | - | - | `1` |
| `collected_until` | Numeric field used for identifiers, counters, or coded values. | `int8` | Yes | No | - | - | `42` |
