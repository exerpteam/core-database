...
| `auto_add_products` | Boolean flag used in business rules and filtering logic. | `bool` | Yes | No | - | - | `true` |
...
| `price_modification_one_time` | Boolean flag used in business rules and filtering logic. | `bool` | Yes | No | - | - | `true` |
| `prompt_type` | Text field containing descriptive or reference information. | `text(2147483647)` | No | No | - | - | `Sample value` |
| `prompt_text` | Text field containing descriptive or reference information. | `text(2147483647)` | Yes | No | - | - | `Sample value` |
...
| `basket_threshold` | Numeric field used for identifiers, counters, or coded values. | `NUMERIC(0,0)` | Yes | No | - | - | `99.95` |
