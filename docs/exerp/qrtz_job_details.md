...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `job_name` | Text field containing descriptive or reference information. | `VARCHAR(200)` | No | Yes | - | - | `Example Name` |
| `job_group` | Text field containing descriptive or reference information. | `VARCHAR(200)` | No | Yes | - | - | `Sample value` |
| `description` | Text field containing descriptive or reference information. | `text(2147483647)` | Yes | No | - | - | `Sample value` |
| `job_class_name` | Text field containing descriptive or reference information. | `text(2147483647)` | No | No | - | - | `Example Name` |
| `is_durable` | Boolean flag indicating whether durable applies. | `bool` | No | No | - | - | `true` |
| `is_volatile` | Boolean flag indicating whether volatile applies. | `bool` | No | No | - | - | `true` |
| `is_stateful` | Boolean flag indicating whether stateful applies. | `bool` | No | No | - | - | `true` |
| `requests_recovery` | Boolean flag used in business rules and filtering logic. | `bool` | No | No | - | - | `true` |
