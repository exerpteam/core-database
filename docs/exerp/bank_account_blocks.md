...
| `clearing_house_id` | Identifier of the related clearing house record. | `int4` | No | No | - | - |
| `creditor_id` | Identifier of the related creditor record. | `text(2147483647)` | No | No | - | - |
...
| `reason` | Text field containing descriptive or reference information. | `text(2147483647)` | No | No | - | - |
