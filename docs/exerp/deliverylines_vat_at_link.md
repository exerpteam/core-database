...
| `deliveryline_center` | Foreign key field linking this record to `delivery_lines_mt`. | `int4` | No | No | [delivery_lines_mt](delivery_lines_mt.md) via (`deliveryline_center`, `deliveryline_id`, `deliveryline_subid` -> `center`, `id`, `subid`) | - | `101` |
| `deliveryline_id` | Foreign key field linking this record to `delivery_lines_mt`. | `int4` | No | No | [delivery_lines_mt](delivery_lines_mt.md) via (`deliveryline_center`, `deliveryline_id`, `deliveryline_subid` -> `center`, `id`, `subid`) | - | `1001` |
| `deliveryline_subid` | Foreign key field linking this record to `delivery_lines_mt`. | `int4` | No | No | [delivery_lines_mt](delivery_lines_mt.md) via (`deliveryline_center`, `deliveryline_id`, `deliveryline_subid` -> `center`, `id`, `subid`) | - | `1` |
