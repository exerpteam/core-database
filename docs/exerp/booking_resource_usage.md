...
| `configuration` | Foreign key field linking this record to `activity_resource_configs`. | `int4` | Yes | No | [activity_resource_configs](activity_resource_configs.md) via (`configuration` -> `id`) | - | `42` |
