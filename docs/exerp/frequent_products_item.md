...
| `frequent_products_list_id` | Foreign key field linking this record to `frequent_products_list`. | `int4` | No | Yes | [frequent_products_list](frequent_products_list.md) via (`frequent_products_list_id` -> `id`) | - | `1001` |
| `product_id` | Foreign key field linking this record to `masterproductregister`. | `int4` | No | Yes | [masterproductregister](masterproductregister.md) via (`product_id` -> `id`) | - | `1001` |
