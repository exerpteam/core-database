...
| `sponsor_invoice_center` | Foreign key field linking this record to `invoices`. | `int4` | Yes | No | [invoices](invoices.md) via (`sponsor_invoice_center`, `sponsor_invoice_id` -> `center`, `id`) | - | `101` |
| `sponsor_invoice_id` | Foreign key field linking this record to `invoices`. | `int4` | Yes | No | [invoices](invoices.md) via (`sponsor_invoice_center`, `sponsor_invoice_id` -> `center`, `id`) | - | `1001` |
