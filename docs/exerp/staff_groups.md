...
| `default_salary` | Numeric field used for identifiers, counters, or coded values. | `NUMERIC(0,0)` | Yes | No | - | - |
| `old_activity_type_id` | Identifier of the related old activity type record. | `int4` | Yes | No | - | - |
| `external_reference` | Text field containing descriptive or reference information. | `VARCHAR(50)` | Yes | No | - | - |
