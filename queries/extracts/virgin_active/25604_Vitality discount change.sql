...
-- Modification of Full Member Extract. Add person external id in parameters to get list of members with current and future subscriptions/prices.
 ...
 MAX ("My payer address 1") AS "My payer address 1",
 MAX ("My payer address 2") AS "My payer address 2",
 MAX ("My payer address 3") AS "My payer address 3",
 MAX ("My payer postcode") AS "My payer postcode",
 MAX ("My payer city") AS "My payer city",
     "Title",
     FIRSTNAME,
     LASTNAME,
     ADDRESS1,
 ...
 FROM
  ...
  CASE r2.RTYPE WHEN 12 THEN payer.address1 ELSE NULL END                                                                                                                 AS "My payer address 1",
 CASE r2.RTYPE WHEN 12 THEN payer.address2 ELSE NULL END                                                                                                                 AS "My payer address 2",
 CASE r2.RTYPE WHEN 12 THEN payer.address3 ELSE NULL END                                                                                                                 AS "My payer address 3",
 CASE r2.RTYPE WHEN 12 THEN payer.zipcode ELSE NULL END                                                                                                                 AS "My payer postcode",
 CASE r2.RTYPE WHEN 12 THEN payer.city ELSE NULL END                                                                                                                 AS "My payer city",
  ...
  s.center||'ss'||s.id                                                                                                                                     AS "Sub ID",
             s.SUBSCRIPTION_PRICE                                                                                            AS "Membership Subscription Value",
             CASE s.STATE WHEN 2 THEN  'ACTIVE'  WHEN 4  THEN  'FROZEN'  WHEN 8 THEN  'CREATED'  WHEN 7 THEN  'WINDOW' END                                                                     AS "Membership Status",
