...
--            mpr2.ID      mpr2_id,
            ...
            mpr2.CACHED_PRODUCTPRICE     price_on_override,
            CASE
			...
			sa_c.shortname addon_center_name
        FROM
        ...
        LEFT JOIN
            xmltable('//product/prices/price' passing XMLType(nvl(mpr2.PRODUCT,mpr.PRODUCT),871)  columns price VARCHAR2(21) path 'normalPrice' , changeDate VARCHAR2(21) path '@start' ) q
        ON
            (
                1=1)
