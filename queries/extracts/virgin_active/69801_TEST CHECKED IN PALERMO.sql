...
(chin.MaxAllowed :: DECIMAL)-(chin.t17 :: DECIMAL) AS "ore 17 AVAILABLE",

chin.t1715 AS "ore 17.15 IN",
(chin.MaxAllowed :: DECIMAL)-(chin.t1715 :: DECIMAL) AS "ore 17.15 AVAILABLE",

chin.t1730 AS "ore 17.30 IN",
(chin.MaxAllowed :: DECIMAL)-(chin.t1730 :: DECIMAL) AS "ore 17.30 AVAILABLE",

chin.t1745 AS "ore 17.45 IN",
(chin.MaxAllowed :: DECIMAL)-(chin.t1745 :: DECIMAL) AS "ore 17.45 AVAILABLE",

chin.t18 AS "ore 18 IN",
(chin.MaxAllowed :: DECIMAL)-(chin.t18 :: DECIMAL) AS "ore 18 AVAILABLE",

chin.t1815 AS "ore 18.15 IN",
(chin.MaxAllowed :: DECIMAL)-(chin.t1815 :: DECIMAL) AS "ore 18.15 AVAILABLE",

chin.t1830 AS "ore 18.30 IN",
(chin.MaxAllowed :: DECIMAL)-(chin.t1830 :: DECIMAL) AS "ore 18.30 AVAILABLE",

chin.t1845 AS "ore 18.45 IN",
(chin.MaxAllowed :: DECIMAL)-(chin.t1845 :: DECIMAL) AS "ore 18.45 AVAILABLE",

chin.t19 AS "ore 19 IN",
(chin.MaxAllowed :: DECIMAL)-(chin.t19 :: DECIMAL) AS "ore 19 AVAILABLE",

chin.t1915 AS "ore 19.15 IN",
(chin.MaxAllowed :: DECIMAL)-(chin.t1845 :: DECIMAL) AS "ore 19.15 AVAILABLE",

chin.t1930 AS "ore 19.30 IN",
(chin.MaxAllowed :: DECIMAL)-(chin.t1845 :: DECIMAL) AS "ore 19.30 AVAILABLE",

chin.t1945 AS "ore 19.45 IN",
(chin.MaxAllowed :: DECIMAL)-(chin.t1845 :: DECIMAL) AS "ore 19.45 AVAILABLE",
...
(SELECT
 ...
 COUNT(
        CASE
            WHEN TO_CHAR(longtodate(ci.checkin_time), 'hh24:MI') <= '17:15'
            AND (TO_CHAR(longtodate(ci.checkout_time), 'hh24') >= '17:15'
 ...
 COUNT(
        CASE
            WHEN TO_CHAR(longtodate(ci.checkin_time), 'hh24:MI') <= '17:30'
            AND (TO_CHAR(longtodate(ci.checkout_time), 'hh24') >= '17:30'
                OR  ci.checkout_time IS NULL
                OR  to_timestamp(ci.checkout_time/1000) :: DATE > :date)
            THEN 1
        END) t1730,
 COUNT(
        CASE
            WHEN TO_CHAR(longtodate(ci.checkin_time), 'hh24:MI') <= '17:45'
            AND (TO_CHAR(longtodate(ci.checkout_time), 'hh24') >= '17:45'
                OR  ci.checkout_time IS NULL
                OR  to_timestamp(ci.checkout_time/1000) :: DATE > :date)
            THEN 1
        END) t1745,
...
COUNT(
        CASE
            WHEN TO_CHAR(longtodate(ci.checkin_time), 'hh24:MI') <= '18:15'
            AND (TO_CHAR(longtodate(ci.checkout_time), 'hh24') >= '18:15'
                OR  ci.checkout_time IS NULL
                OR  to_timestamp(ci.checkout_time/1000) :: DATE > :date)
            THEN 1
        END) t1815,
...
COUNT(
        CASE
            WHEN TO_CHAR(longtodate(ci.checkin_time), 'hh24:MI') <= '18:30'
            AND (TO_CHAR(longtodate(ci.checkout_time), 'hh24') >= '18:30'
                OR  ci.checkout_time IS NULL
                OR  to_timestamp(ci.checkout_time/1000) :: DATE > :date)
            THEN 1
        END) t1830,
...
COUNT(
        CASE
            WHEN TO_CHAR(longtodate(ci.checkin_time), 'hh24:MI') <= '18:45'
            AND (TO_CHAR(longtodate(ci.checkout_time), 'hh24') >= '18:45'
                OR  ci.checkout_time IS NULL
                OR  to_timestamp(ci.checkout_time/1000) :: DATE > :date)
            THEN 1
        END) t1845,
...
COUNT(
        CASE
            WHEN TO_CHAR(longtodate(ci.checkin_time), 'hh24:MI') <= '19:15'
            AND (TO_CHAR(longtodate(ci.checkout_time), 'hh24') >= '19:15'
                OR  ci.checkout_time IS NULL
                OR  to_timestamp(ci.checkout_time/1000) :: DATE > :date)
            THEN 1
        END) t1915,
...
COUNT(
        CASE
            WHEN TO_CHAR(longtodate(ci.checkin_time), 'hh24:MI') <= '19:30'
            AND (TO_CHAR(longtodate(ci.checkout_time), 'hh24') >= '19:30'
                OR  ci.checkout_time IS NULL
                OR  to_timestamp(ci.checkout_time/1000) :: DATE > :date)
            THEN 1
        END) t1930,
...
COUNT(
        CASE
            WHEN TO_CHAR(longtodate(ci.checkin_time), 'hh24:MI') <= '19:45'
            AND (TO_CHAR(longtodate(ci.checkout_time), 'hh24') >= '19:45'
                OR  ci.checkout_time IS NULL
                OR  to_timestamp(ci.checkout_time/1000) :: DATE > :date)
            THEN 1
        END) t1945,
