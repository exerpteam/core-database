...
WHERE 
pr.center IN (205,204,207,206,201,203,202,220,221,222,223,216,217,218,219,212,213,214,215,208,209,210,211,102,103,100,101,108,106,107,225,104,224,105,227,226) 
--c.country = 'IT'
and pr.STATE IN(5,12,17)

and extract(day from pr.req_date) <= 2

AND  extract(year from pr.req_date)>= 2018
