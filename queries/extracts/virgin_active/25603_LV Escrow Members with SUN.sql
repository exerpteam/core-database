WITH
    ...
    (
        SELECT DISTINCT
			...
			DECODE (pa.clearinghouse, 1, '836301', 601, '837394', 201, '768308', 401, '911116')	AS dd_SUN,
                ...
                OR (
                    ...
                    (
                        ...
                        WHERE
                            ...
                            AND scl.BOOK_END_TIME IS NULL
                            AND scl.STATEID=2
                            AND scl.ENTRY_START_TIME > exerpro.datetolong(TO_CHAR(add_months(SYSDATE,-24),'YYYY-MM-DD HH24:MI'))) 
                    AND NOT EXISTS
                    (
                        SELECT
                            1
