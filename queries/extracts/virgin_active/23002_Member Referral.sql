...
SELECT
    ...
    TO_CHAR(EXERPRO.longtodate(s.CREATION_TIME),'yyyy-MM-dd')                                                                                                                              AS Join_Date,
    ...
    DECODE (referrer.STATUS, 0,'LEAD', 1,'ACTIVE', 2,'INACTIVE', 3,'TEMPORARYINACTIVE', 4,'TRANSFERED', 5,'DUPLICATE', 6,'PROSPECT', 7,'DELETED',8, 'ANONYMIZED', 9, 'CONTACT', 'UNKNOWN') AS referrer_STATUS ,
    ...
    TO_CHAR(EXERPRO.longtodate(rs.CREATION_TIME),'yyyy-MM-dd')                                                                                                                             AS referrer_Join_Date,
...
WHERE
    ...
    (
        ...
        WHERE
            (
                s2.END_DATE > add_months(exerpro.longtodatetz(s.CREATION_TIME,'Europe/London'),-1)
