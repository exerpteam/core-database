...
CASE
	...
	WHEN "Membership Subscription" = 'Club Only Joint Flexi'
	THEN '42.00'

	WHEN "Membership Subscription" = 'Club Only 16 Plus Flexi'
	THEN '36.00'

	WHEN "Membership Subscription" IN ('Carer','Ancillary by DD base subscription','Club Staff Buddy','Club Staff','Group Ex Staff', 'Complimentary')
	THEN 'Zero'

	WHEN "Membership Subscription" IN ('Club Only 55 Plus Flexi','Club Only 55 Plus 3 Month')
	THEN '41.00'

	WHEN "Membership Subscription" IN ('Club Only Off Peak 12 Month','Esporta All Off Peak 55 Plus Flexi','Esporta All Off Peak Flexi','Esporta Club Only Off Peak Flexi','Multi Access Off Peak Flexi','Multi Access Off Peak 55 Plus Flexi','Multi Access 55 Plus Flexi V1')
	THEN '44.00'

  	WHEN "Membership Subscription" IN ('All Access Flexi','Esporta All Flexi','Multi Access 12 Month','Multiclub 12 Month')
	THEN '51.00'

  	WHEN "Membership Subscription" IN ('Esporta All Concession Flexi','Esporta Non Premium 55 Plus Flexi','Multi Access Concession Flexi', 'Multi Access 55 Plus Flexi V1')
	THEN '45.00'

  	WHEN "Membership Subscription" IN ('All Access Corporate Flexi','Esporta All Corporate Flexi','Multi Access Corporate 12 Month','Multiclub Corporate 12 Month')
	THEN '47.94'

  	WHEN "Membership Subscription" IN ('Multi Access Corporate 12 Month','Multiclub Corporate 12 Month','Multi Access Corporate Flexi','Multiclub Corporate Flexi','Club Only Racquets Corporate Flexi','Esporta Non Premium Racquets Corporate Flexi','Club Only Corporate Flexi','Multi Access Racquets Corporate Flexi V2')
	THEN '53.96'

  	WHEN "Membership Subscription" IN ('Club Only Flexi','Multi Access Flexi','Multiclub Flexi','Multiclub Pru Legacy 50% Flexi')
	THEN '59.95'

  	WHEN "Membership Subscription" IN ('Esporta All Joint Flexi','Esporta Non Premium Joint Flexi','Multi Access Joint Flexi','Multiclub Joint Flexi','Multi Access Joint Flexi V1','Multi Access Joint Flexi V2')
   	THEN '45.00'

  	WHEN "Membership Subscription" IN ('Multi Access Vitality 50% Flexi','Multiclub Vitality 25% Flexi','Multiclub Vitality 50% Flexi')
	THEN '29.98'
	
  	WHEN "Membership Subscription" LIKE '%Funded%' OR "Membership Subscription" LIKE '%Gymflex%'  
	THEN 'Determined by the Corporate Team'

	WHEN "Membership Subscription" IN ('Multiclub Tribe 12 Month','Multiclub Tribe Flexi', 'Multi Access Tribe Flexi', 'Multi Access Tribe 12 Month')
	THEN '41.97'

  	WHEN "Membership Subscription" IN ('Club Only Junior 3-15 Flexi','Club Only Racquets Junior 3-15 Flexi','Esporta All Junior 3-15 Flexi','Multiclub Junior 3-15 Flexi','Multiclub Racquets Junior 3-15 Flexi') and "Membership Subscription Value" = 0
	THEN 'Terminate zero priced junior'

  	WHEN "Membership Subscription" IN ('Club Only Junior 3-15 Flexi','Club Only Racquets Junior 3-15 Flexi','Esporta All Junior 3-15 Flexi','Multiclub Junior 3-15 Flexi','Multiclub Racquets Junior 3-15 Flexi') and "Membership Subscription Value" > 0
	THEN '15.00'

  	WHEN "Membership Subscription" LIKE '%PFL%' or "Membership Subscription" LIKE '%PFL%'  
	THEN 'Option to stay on PFL'

  	WHEN "Membership Subscription" = 'Multiclub Junior 0-2 Flexi' and "Membership Subscription Value" = 0
	THEN 'Terminate zero priced junior'

  	WHEN "Membership Subscription" =  'Multiclub Junior 0-2 Flexi' and "Membership Subscription Value" > 0
	THEN '7.00'
	
  	WHEN "Membership Subscription" IN ('Esporta All Student Flexi','Esporta Non Premium Student Flexi','Club Only Student Flexi','Multi Access Student Flexi V1','Multi Access Student Flexi')
	THEN 'TBC'

  	WHEN "Membership Subscription" LIKE '%Annual%'  
	THEN 'Annual Transfer Options'

	ELSE 'Not Mapped'
END AS "New_Subscription_Price",
CASE

	WHEN "Membership Subscription" = 'Club Only Joint Flexi'
	THEN 'Club Only Joint Flexi v10'

	WHEN "Membership Subscription" IN ('Carer','Ancillary by DD base subscription','Club Staff Buddy','Club Staff','Group Ex Staff', 'Complimentary')
	THEN 'Member to be terminated'

	WHEN "Membership Subscription" = 'Club Only 16 Plus Flexi'
	THEN 'Club Only 16 Plus Flexi v10'

	WHEN "Membership Subscription" IN ('Club Only 55 Plus Flexi','Club Only 55 Plus 3 Month')
	THEN 'Club Only 55 Plus Flexi v10'
  
  	WHEN "Membership Subscription" IN ('Club Only Off Peak 12 Month','Esporta All Off Peak 55 Plus Flexi','Esporta All Off Peak Flexi','Esporta Club Only Off Peak Flexi','Multi Access Off Peak Flexi','Multi Access Off Peak 55 Plus Flexi')
	THEN 'Club Only Off Peak Flexi v10'
  
  	WHEN "Membership Subscription" IN ('All Access Flexi','Esporta All Flexi','Multi Access 12 Month','Multiclub 12 Month')
	THEN 'Multi Access 12 Month v10'
  
  	WHEN "Membership Subscription" IN ('Esporta All Concession Flexi','Esporta Non Premium 55 Plus Flexi','Multi Access Concession Flexi', 'Multi Access 55 Plus Flexi V1')
	THEN 'Multi Access 55 Plus Flexi v10'
  
  	WHEN "Membership Subscription" IN ('All Access Corporate Flexi','Esporta All Corporate Flexi','Multi Access Corporate 12 Month','Multiclub Corporate 12 Month')
	THEN 'Multi Access Corporate 12 Month v10'
  
  	WHEN "Membership Subscription" IN ('Multi Access Corporate 12 Month','Multiclub Corporate 12 Month','Multi Access Corporate Flexi','Multiclub Corporate Flexi','Club Only Racquets Corporate Flexi','Esporta Non Premium Racquets Corporate Flexi','Club Only Corporate Flexi','Multi Access Racquets Corporate Flexi V2')
	THEN 'Multi Access Corporate Flexi v10'
  
  	WHEN "Membership Subscription" IN ('Club Only Flexi','Multi Access Flexi','Multiclub Flexi','Multiclub Pru Legacy 50% Flexi')
	THEN 'Multi Access Flexi v10'
  
  	WHEN "Membership Subscription" IN ('Esporta All Joint Flexi','Esporta Non Premium Joint Flexi','Multi Access Joint Flexi','Multiclub Joint Flexi','Multi Access Joint Flexi V1','Multi Access Joint Flexi V2')
	THEN 'Multi Access Joint Flexi v10'

	WHEN "Membership Subscription" IN ('Multi Access Vitality 50% Flexi','Multiclub Vitality 25% Flexi','Multiclub Vitality 50% Flexi')
	THEN 'Multi Access Vitality 50% Flexi v10'
  
	WHEN "Membership Subscription" like '%Funded%' OR "Membership Subscription"  LIKE '%Gymflex%'  
	THEN 'Managed by the Corporate Team'

  	WHEN "Membership Subscription" IN ('Multiclub Tribe 12 Month','Multiclub Tribe Flexi', 'Multi Access Tribe Flexi', 'Multi Access Tribe 12 Month')
	THEN 'Multiclub Tribe Flexi v10'

  	WHEN "Membership Subscription" IN ('Club Only Junior 3-15 Flexi','Club Only Racquets Junior 3-15 Flexi','Esporta All Junior 3-15 Flexi','Multiclub Junior 3-15 Flexi','Multiclub Racquets Junior 3-15 Flexi')
	THEN 'Multi Access Junior 3-15 Flexi v10'
  
	WHEN "Membership Subscription" LIKE '%PFL%' OR "Membership Subscription"  LIKE '%Price%'  
	THEN 'Price for Life Annual Letter'

	WHEN "Membership Subscription" = 'Multiclub Junior 0-2 Flexi'
	THEN 'Multiclub Junior 0-2 Flexi v10'
...
END AS "New Subscription",
    ...
    MAX("Company Contact's Title")              AS "Company Contacts Title",
    MAX("Comp Contact's Firstname")             AS "Comp Contacts Firstname",
    MAX("Comp Contact's Last Name")             AS "Comp Contacts Last Name",
    MAX("Comp Contact's Address Line 1")        AS "Comp Contacts Address Line 1" ,
    MAX("Comp Contact's Address Line 2")        AS "Comp Contacts Address Line 2" ,
    MAX("Comp Contact's Address Line 3")        AS "Comp Contacts Address Line 3" ,
    MAX("Comp Contact's Post Code")             AS "Comp Contacts Post Code" ,
    MAX("Comp Contact's E-mail")                AS "Comp Contacts E-mail" ,
    MAX("Comp Contact's Mobile")                AS "Comp Contacts Mobile" ,
...
CASE
	...
	THEN '44.00'
  	...
  	WHEN "Membership Subscription" IN ('Esporta All Flexi','Multi Access 12 Month','Multiclub 12 Month')
	THEN '51.00'

  	WHEN "Membership Subscription" IN ('Esporta All Concession Flexi','Esporta Non Premium 55 Plus Flexi','Multi Access Concession Flexi', 'Multi Access 55 Plus Flexi V1')
	THEN '45.00'

  	WHEN "Membership Subscription" IN ('Esporta All Corporate Flexi','Multi Access Corporate 12 Month','Multiclub Corporate 12 Month')
	THEN '47.94'
	...
	THEN 'TBC'
  	...
  	WHEN "Membership Subscription" = 'All Access Corporate Flexi'
	THEN '47.94'

  	WHEN "Membership Subscription" = 'All Access Flexi' 
	THEN '51.00'
...
THEN 'Club Only Off Peak Flexi v10'
	...
	WHEN "Membership Subscription" like '%Price%' OR "Membership Subscription"  like '%PFL%'  
	THEN 'Price for Life Annual Letter'

	WHEN "Membership Subscription" = 'Multiclub Junior 0-2 Flexi'
	THEN 'Multiclub Junior 0-2 Flexi v10'
	
  	WHEN "Membership Subscription" IN ('Esporta All Student Flexi','Esporta Non Premium Student Flexi','Club Only Student Flexi','Multi Access Student Flexi','Multi Access Student Flexi V1')
	THEN 'Student Issue'

  	WHEN "Membership Subscription" = 'All Access Corporate Flexi'
	THEN 'All Access Corporate Flexi v10'

  	WHEN "Membership Subscription" = 'All Access Flexi' 
	THEN 'All Access Flexi v10'
