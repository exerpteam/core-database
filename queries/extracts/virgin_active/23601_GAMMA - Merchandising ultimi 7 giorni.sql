...
--  
 SELECT  trunc(current_timestamp)-1 ,  c.SHORTNAME as "CLUB",  empl1.FULLNAME as "EMPLOYER", person.FULLNAME as "PERSON", payer.FULLNAME AS "PAYER", p.NAME AS "NAME", invl.TOTAL_AMOUNT as "AMOUNT",
 ...
 WHERE
  longToDate(inv.ENTRY_TIME) BETWEEN  trunc(current_timestamp)-7 AND trunc(current_timestamp)
 and c.COUNTRY = 'IT'
