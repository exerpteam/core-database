...
FROM
    (
        ...
        ON
            ...
            AND scl.BOOK_START_TIME BETWEEN dateToLong(TO_CHAR(TRUNC(sysdate-1), 'YYYY-MM-dd HH24:MI')) AND dateToLong(TO_CHAR(TRUNC(sysdate), 'YYYY-MM-dd HH24:MI'))-1
        UNION ALL
        ...
        ON
            ...
            AND pg.NAME = 'Pru'
        WHERE
            s.CREATION_TIME BETWEEN dateToLong(TO_CHAR(TRUNC(sysdate-1), 'YYYY-MM-dd HH24:MI')) AND dateToLong(TO_CHAR(TRUNC(sysdate), 'YYYY-MM-dd HH24:MI'))-1
        ...
        WHERE
            ...
            AND s.CREATION_TIME < dateToLong(TO_CHAR(TRUNC(sysdate-1),'YYYY-MM-dd HH24:MI'))
            AND TRUNC(longToDate(scl.BOOK_START_TIME)) = TRUNC(sysdate)
    )
    i1
    /****************************/
