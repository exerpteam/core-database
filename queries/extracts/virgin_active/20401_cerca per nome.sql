 SELECT DISTINCT P.CENTER AS CENTER, P.ID AS ID, P.FULLNAME AS FULLNAME,
     ...
     join PERSON_EXT_ATTRS PEA3 ON (PEA3.PERSONCENTER =
         ...
         AND PEA3.NAME = '_eClub_PhoneSMS')  WHERE P.CENTER IN (205,204,207,206,201,203,202,220,221,222,223,216,217,218,219,212,213,214,215,208,209,210,211,102,103,100,101,108,106,107,225,104,224,105) AND (P.FULLNAME) in (:PERSON)
