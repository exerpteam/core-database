 SELECT DISTINCT
     ...
     s.CENTER || 'ss' || s.ID "Membership Number",
         CASE
                 WHEN sfp.START_DATE >= TO_DATE('20200224', 'yyyymmdd') AND sfp.END_DATE >= TO_DATE('20200331', 'yyyymmdd') THEN TO_DATE('20200331', 'yyyymmdd') - sfp.START_DATE +1
                 WHEN sfp.START_DATE < TO_DATE('20200224', 'yyyymmdd') AND sfp.END_DATE >= TO_DATE('20200331', 'yyyymmdd') THEN TO_DATE('20200331', 'yyyymmdd') - TO_DATE('20200224', 'yyyymmdd') +1
                 WHEN sfp.START_DATE < TO_DATE('20200224', 'yyyymmdd') AND sfp.END_DATE <= TO_DATE('20200331', 'yyyymmdd') THEN sfp.END_DATE -  TO_DATE('20200224', 'yyyymmdd') +1
                 WHEN sfp.START_DATE >= TO_DATE('20200224', 'yyyymmdd') AND sfp.END_DATE <= TO_DATE('20200331', 'yyyymmdd') THEN sfp.END_DATE - sfp.START_DATE +1
         END "giorni freeze",
 ...
 WHERE
     (
         sfp.START_DATE BETWEEN TO_DATE('20200224', 'yyyymmdd') AND TO_DATE('20200331', 'yyyymmdd')
                 OR
                 sfp.END_DATE BETWEEN TO_DATE('20200224', 'yyyymmdd') AND TO_DATE('20200331', 'yyyymmdd')
                 OR
                 (sfp.START_DATE < TO_DATE('20200224', 'yyyymmdd') AND sfp.END_DATE > TO_DATE('20200331', 'yyyymmdd'))
      )
     AND sfp.STATE != 'CANCELLED'
     AND s.center IN (104,105,202,203,204,207,209,216,218,223,224,225,228,229)
