SELECT
    TO_CHAR($$BookDate$$, 'YYYY-MM-DD') "Date",
    extId MeasureID,
        ...
        LEFT JOIN
            (
                ...
                WHERE
                    ...
                    AND art.TRANS_TIME >= datetolongC(TO_CHAR($$BookDate$$, 'YYYY-MM-DD HH24:MI'), art.CENTER)
                    AND art.TRANS_TIME < datetolongC(TO_CHAR($$BookDate$$, 'YYYY-MM-DD HH24:MI'), art.CENTER) + (1000*60*60*24)
                    AND NOT(
                        art.TRANSFERRED = 1
