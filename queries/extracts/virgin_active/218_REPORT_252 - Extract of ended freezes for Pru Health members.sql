...
ON
    ...
    AND sbp.END_DATE >= to_date(TO_CHAR(add_months(sysdate,1),'yyyy-MM') || '-01','yyyy-MM-dd')
    AND sbp.END_DATE < to_date(TO_CHAR(add_months(sysdate,2),'yyyy-MM') || '-01','yyyy-MM-dd')
