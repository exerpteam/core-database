WITH
    ...
    (
        ...
        AND (
            ...
            (
                ...
                AND cc.CLOSED = 0
                    --and cc.PERSONCENTER in (select id from scopes)
                AND (
        ...
        AND (
            ...
            (
                ...
                AND cc.STARTDATE < CURRENT_TIMESTAMP - 30
                AND cc.CLOSED = 0
                    -- and op_rel.RELATIVECENTER in (select id from scopes)
                AND (
    ...
    (
        SELECT DISTINCT
            *,
            COUNT(*) AS "counter"
            --            COUNT(*) over (partition BY personcenter,personid) AS counter
        FROM
            subs_persons
        GROUP BY
            subcenter,
