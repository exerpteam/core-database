...
-- https://clublead.atlassian.net/browse/ST-11906
  SELECT
     cen.SHORTNAME,
     SS.SALES_DATE,
 ...
 ON
     cen.ID = p.CENTER
 LEFT JOIN
     INVOICELINES af -- activation fee
 ON
     af.center = su.INVOICELINE_CENTER
         AND af.id = su.INVOICELINE_ID
         AND af.subid = su.INVOICELINE_SUBID
 LEFT JOIN
     PRODUCT_GROUP prg
 ON
