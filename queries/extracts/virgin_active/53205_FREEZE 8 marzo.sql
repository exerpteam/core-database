 SELECT DISTINCT
     ...
     s.CENTER || 'ss' || s.ID "Membership Number",
         CASE
                 WHEN sfp.START_DATE >= TO_DATE('20200308', 'yyyymmdd') AND sfp.END_DATE >= TO_DATE('20200331', 'yyyymmdd') THEN TO_DATE('20200331', 'yyyymmdd') - sfp.START_DATE +1
                 WHEN sfp.START_DATE < TO_DATE('20200308', 'yyyymmdd') AND sfp.END_DATE >= TO_DATE('20200331', 'yyyymmdd') THEN TO_DATE('20200331', 'yyyymmdd') - TO_DATE('20200308', 'yyyymmdd') +1
                 WHEN sfp.START_DATE < TO_DATE('20200308', 'yyyymmdd') AND sfp.END_DATE <= TO_DATE('20200331', 'yyyymmdd') THEN sfp.END_DATE -  TO_DATE('20200308', 'yyyymmdd') +1
                 WHEN sfp.START_DATE >= TO_DATE('20200308', 'yyyymmdd') AND sfp.END_DATE <= TO_DATE('20200331', 'yyyymmdd') THEN sfp.END_DATE - sfp.START_DATE +1
         END "giorni freeze",
 ...
 WHERE
     (
         sfp.START_DATE BETWEEN TO_DATE('20200308', 'yyyymmdd') AND TO_DATE('20200331', 'yyyymmdd')
                 OR
                 sfp.END_DATE BETWEEN TO_DATE('20200308', 'yyyymmdd') AND TO_DATE('20200331', 'yyyymmdd')
                 OR
                 (sfp.START_DATE < TO_DATE('20200308', 'yyyymmdd') AND sfp.END_DATE > TO_DATE('20200331', 'yyyymmdd'))
      )
     AND sfp.STATE != 'CANCELLED'
     AND s.center IN (211,212,205,221,226,231)
