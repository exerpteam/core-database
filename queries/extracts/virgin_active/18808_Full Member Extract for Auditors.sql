...
SELECT
             ...
             to_date(getcentertime(s.center),'YYYY-MM-DD') + interval '1 day' - ccc.STARTDATE                                                                                AS "Age of oldest debt (DAYS)",
             ...
             CASE
                 WHEN cc.valid_until > dateToLong(getcentertime(p.center))
                     AND cc.clips_left>0
                 THEN 1
                 ELSE 0
         ...
         LEFT JOIN
             ...
             (
                 ...
                 WHERE
                     s.center IN ($$scope$$)
                     AND s.START_DATE <= to_date(getcentertime(s.center),'YYYY-MM-DD')
                     AND (
                         s.END_DATE > to_date(getcentertime(s.center),'YYYY-MM-DD')
             ...
             (
                 ...
                 ON
                     ...
                     AND ppgl2.PRODUCT_GROUP_ID IN(276,
                                                   277)
                 WHERE
                     sa.START_DATE <= to_date(getcentertime(s1.center),'YYYY-MM-DD')
                     AND (
                         sa.END_DATE > to_date(getcentertime(s1.center),'YYYY-MM-DD')
         ...
         LEFT JOIN
             (
                 ...
                 ON
                     ...
                     AND cc.valid_until > dateToLong(TO_CHAR(to_date(getcentertime(cc.OWNER_CENTER),'YYYY-MM-DD'), 'YYYY-MM-dd HH24:MI'))
         ...
         LEFT JOIN
             (
                 ...
                 ON
                     ...
                     AND pg.VALID_FROM < dateToLong(TO_CHAR(to_date(getcentertime(s.center),'YYYY-MM-DD')+1, 'YYYY-MM-dd HH24:MI'))
                     AND (
                         pg.VALID_TO >=dateToLong(TO_CHAR(to_date(getcentertime(s.center),'YYYY-MM-DD')+1, 'YYYY-MM-dd HH24:MI'))
  ...
  and pg.GRANTER_SERVICE = 'CompanyAgreement'
                 ...
                 ON
                     ...
                     AND pp.VALID_FROM < dateToLong(TO_CHAR(to_date(getcentertime(s.center),'YYYY-MM-DD')+1, 'YYYY-MM-dd HH24:MI'))
                     AND (
                         pp.VALID_TO >= dateToLong(TO_CHAR(to_date(getcentertime(s.center),'YYYY-MM-DD')+1, 'YYYY-MM-dd HH24:MI'))
         ...
         LEFT JOIN
             (
                 ...
                 WHERE
                     pu.USE_TIME BETWEEN datetolong(TO_CHAR(DATE_TRUNC('month',to_date(getcentertime(par.PARTICIPANT_CENTER),'YYYY-MM-DD')), 'YYYY-MM-DD HH24:MM')) AND datetolong(TO_CHAR(to_date(getcentertime(par.PARTICIPANT_CENTER),'YYYY-MM-DD'), 'YYYY-MM-DD HH24:MM'))
                 GROUP BY
