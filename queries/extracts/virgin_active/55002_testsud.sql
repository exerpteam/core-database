 ...
 WITH
     ...
     (
         SELECT
             ...
             $$to_date$$ +  24*3600*1000 AS TODATE
...
paid_pr.request_type
 ...
 ON
     ...
     AND paid_pr.inv_coll_subid = paid_prs.subid
         ...
         AND paid_pr.request_type in (1,6)
 LEFT JOIN
 ...
 WHERE
     ...
     AND art.text IN ('FreeCreditnote: Insoluto Irrecuperabile',
'FreeCreditNote: Insoluto Irrecuperabile',
                      'Payment into account',
                      'Manual registered payment of request: Payment open request')
