SELECT DISTINCT
    ...
    pa.clearinghouse,
    FIRST_VALUE(exerpro.longToDate(pr.ENTRY_TIME)) OVER (PARTITION BY acl.AGREEMENT_CENTER,acl.AGREEMENT_ID,acl.AGREEMENT_SUBID ORDER BY pr.ENTRY_TIME ASC)                                                                                                                                                                              LATEST_REQUEST_CREATED,
    ...
    pa.STATE                                                                                                                                                                                                        PA_STATE_ID,
pa.EXPIRATION_DATE,
    pa.REF                                                                                                                                                                                                        AGREEMENT_REFERENCE,
    ...
    FIRST_VALUE(exerpro.longToDate(acl.ENTRY_TIME)) OVER (PARTITION BY acl.AGREEMENT_CENTER,acl.AGREEMENT_ID,acl.AGREEMENT_SUBID ORDER BY acl.LOG_DATE ASC)                                                                                                                                                                              EARLIEST_LOG_ENTRY_TIME,
    ...
    FIRST_VALUE(exerpro.longToDate(acl.ENTRY_TIME)) OVER (PARTITION BY acl.AGREEMENT_CENTER,acl.AGREEMENT_ID,acl.AGREEMENT_SUBID ORDER BY acl.LOG_DATE DESC)                                                                                                                                                                             LATEST_LOG_ENTRY_TIME,
    exerpro.longToDate(pa.CREATION_TIME)                                                                                                                                                                                                        agreement_created,
