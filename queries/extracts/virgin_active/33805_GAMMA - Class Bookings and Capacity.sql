...
--             dual
 ...
 JOIN
     (
         ...
         WHERE
             bo1.CENTER IN ($$scope$$)
             AND bo1.STARTTIME>= params1.PeriodStart::bigint
             AND bo1.STARTTIME<= params1.PeriodEnd::bigint
 ...
 WHERE
     ...
     AND bo.STARTTIME>= params.PeriodStart::bigint
     AND bo.STARTTIME<= params.PeriodEnd::bigint
     AND bo.STATE='ACTIVE'
 ORDER BY
     c.NAME,
     bo.starttime,
