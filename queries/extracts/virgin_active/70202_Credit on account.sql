...
BALANCE, 
--TO_TIMESTAMP(LAST_ENTRY_TIME / 1000.0),
TO_TIMESTAMP(LAST_TRANS_TIME / 1000.0) Last_Transaction_Date,
--MobilePhone.TxtValue as MobilePhone, HomePhone.TxtValue AS HomePhone,
