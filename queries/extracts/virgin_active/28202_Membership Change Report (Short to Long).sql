...
-- https://clublead.atlassian.net/browse/ST-2671
 SELECT DISTINCT
     CLUB,
     ID_MEMBER,
         ...
         JOIN
             (
                 ...
                 WHERE
                     ...
                     AND TRUNC(ss.sales_date) BETWEEN TRUNC(CAST($$from_date$$ AS DATE)) AND TRUNC(CAST($$to_date$$ AS DATE)) ) sub_sale
         ON
 ...
 WHERE
     mem_change.PREVIOUS_SUBSCRIPTION_TYPE = 'SHORT'
