...
AND act.trans_TIME < params.toDateLong 
and ((t1.external_id = '2135') or (acc.external_id = '2135')) and t1.external_id not in ('AR_CASH','2131') and t1.globalid not in ('BANKACCOUNT_CREDITCARD') and (ar.CUSTOMERCENTER,ar.CUSTOMERID) in(:memberid)
 ) r3   