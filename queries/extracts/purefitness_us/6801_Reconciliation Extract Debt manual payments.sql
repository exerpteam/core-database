...
on
act.entry_time-5550 < t1.entry_time
and act.entry_time+35550 > t1.entry_time
...
AND act.trans_TIME < params.toDateLong 
and ((t1.external_id = '2135') or (acc.external_id = '2135')) and t1.external_id not in ('AR_CASH','2131') and t1.globalid not in ('BANKACCOUNT_CREDITCARD')
 ) r3   