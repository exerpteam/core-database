...
WITH
    ...
    (
        SELECT distinct
            ...
            CAST(dateToLongC(TO_CHAR((s.d1 + INTERVAL '3 hours'), 'YYYY-MM-DD HH24:MI:SS') , c.id) AS BIGINT) AS
            lower_bound,
            CAST(dateToLongC(TO_CHAR((s.d1 + INTERVAL '3 hours' + INTERVAL '1 hour'), 'YYYY-MM-DD HH24:MI:SS'), c.id)
