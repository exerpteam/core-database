...
( 
    ...
    WHERE
        pag.clearinghouse IN (4601,1,4801,201)
        AND pag.clearinghouse_ref ~ '^([a-f0-9\-]{36}\|\d+|[a-f0-9]{40})$'
        AND pag.creation_time BETWEEN 1748908800000 AND 1748995150000
...
WHERE pea.txtvalue like '%fu%'
    AND pag.clearinghouse IN (4601,1,4801,201)
    -- and pag.clearinghouse_ref ~ '^([a-f0-9\-]{36}\|\d+|[a-f0-9]{40})$'
