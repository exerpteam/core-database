...
SELECT
   ...
   p.external_id AS ExternalID,
    ...
    il.product_normal_price AS Precio_Real_por_unidad,
    il.total_amount AS Precio_pagado, 
   p.LAST_ACTIVE_START_DATE AS Ult_Fecha_Active_Start_Date
...
WHERE
    il.text             IN ('ONE EXPERIENCE PLUS', 'ONE EXPERIENCE PT', 'ONE EXPERIENCE PLUS PT', 'ONE EXPERIENCE')
