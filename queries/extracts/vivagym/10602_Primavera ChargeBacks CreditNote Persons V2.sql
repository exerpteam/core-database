...
(
        ...
        SELECT
                ...
                TO_CHAR(longToDateC(cn.entry_time, cn.center),'YYYY-MM-DD') || ' 00:00:00' AS OriginalDocumentDate,
                cn.center || 'cred' || cn.id AS OriginalDocumentReference,
                cn.fiscal_export_token AS OriginalDocumentExerpID,
                par.batch_id,
                prs.ref,
