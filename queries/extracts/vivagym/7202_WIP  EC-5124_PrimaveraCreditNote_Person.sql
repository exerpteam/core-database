...
(
        ...
        (
                ...
                SELECT  
                        ...
                        longToDateC(cn.trans_time, cn.center) AS paymentDate, -- THEY ARE PAID AUTOMATICALLY
                        ...
                        CAST(extract(YEAR FROM longToDateC(i.entry_time, i.center)) AS TEXT) || 'U' AS RefDocumentSerie
                ...
                SELECT
                        ...
                        longToDateC(cn.trans_time, cn.center) AS paymentDate, -- THIS IS NOT 100% CORRECT AS THIS IS WHEN THE SETTLEMENT HAPPENS (PROBABLY ONE DAY BEFORE PAYMENT WAS DONE)
                        cnl.center || 'cred' || cnl.id AS Referencia,
                        cn.fiscal_export_token AS CDU_ExerpID,
                        SUM(cnl.total_amount) over (partition BY cnl.CENTER,cnl.ID) AS CDU_ExerpTotalDocument,
                        ...
                        par.batch_id,
                        i.fiscal_reference AS RefDocumentNumDoc,
                        CAST(extract(YEAR FROM longToDateC(i.entry_time, i.center)) AS TEXT) || 'P' AS RefDocumentSerie
                FROM vivagym.credit_note_lines_mt cnl
                JOIN params par
                        ON par.center_id = cnl.center
                JOIN vivagym.credit_notes cn
