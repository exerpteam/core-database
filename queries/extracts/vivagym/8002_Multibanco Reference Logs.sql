...
LEFT JOIN vivagym.person_ext_attrs pea ON pea.personcenter = p.center AND pea.personid = p.id AND pea.name = 'MBREF'
JOIN
    params
 ON
    params.CenterID = pcl.person_center
WHERE pcl.change_attribute = 'MBREF'
