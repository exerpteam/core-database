...
(
        SELECT
                ...
                DATETOLONGc(TO_CHAR(to_date(:fromDate,'YYYY-MM-DD') + interval '3 days','YYYY-MM-DD'),c.id)-0 as toDate,
                DATETOLONGc(TO_CHAR(to_date(:toDate,'YYYY-MM-DD') + interval '3 days','YYYY-MM-DD'),c.id)-0 as endofMonth,
                c.id
        ...
        (
                ...
                (
                        ...
                        WHERE
                                ...
                                AND art.employeecenter IS NULL AND art.employeeid IS NULL
