...
ON
    t1.PersonCenter = pac.center
    AND t1.PersonId = pac.id
JOIN
...
WHERE
ch.name IN ('Invoice MIL', 'Invoice HUT', 'Invoice BPL', 'Invoice GVA', 'Invoice LAU', 'Invoice SEE', 'Invoice ZUR','Standing Orders CPL', 'Standing Orders BPL','Standing Orders HUT', 'Standing Orders GVA', 'Standing Orders LAU','Standing Orders SEE', 'Standing Orders ZUR', 'Standing Orders CPL')
