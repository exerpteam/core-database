    ...
    to_char(exerpro.longtodate(dms.ENTRY_START_TIME),'HH24:MI') as Change_Time,
    DECODE(dms.CHANGE,0,'Other',1,'Joiner',2,'Rejoiner',3,'Reactivated',4,'Leaver',5,'Change membership',6,'Transfer in',7,'Transfer out',8,'Transfer in and change membership') AS Change,
...
WHERE
    dms.ENTRY_START_TIME > dateToLong(to_char(trunc(sysdate-5), 'YYYY-MM-dd HH24:MI'))
