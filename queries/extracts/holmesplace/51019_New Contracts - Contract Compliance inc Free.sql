...
stype.BINDINGPERIODCOUNT  		AS "BindingPeriod",
	...
	vk.TXTVALUE						AS  "Vertragskorrektur",
	ReceiptID.TXTVALUE				AS "AuthCode",
...
LEFT JOIN
    PERSON_EXT_ATTRS ReceiptID
ON
    owner.center = ReceiptID.PERSONCENTER
    AND owner.id = ReceiptID.PERSONID
    AND ReceiptID.name = 'ReceiptID'
