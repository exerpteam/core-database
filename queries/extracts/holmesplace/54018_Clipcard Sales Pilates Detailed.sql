...
AS CLUB,
   ...
   CASE customer.status
	...
	invoiceLine.net_amount "NET_AMOUNT",
	CASE
...
WHERE
    ...
    AND (
prodg.name IN ('Pilates Income','GroupXpaid','GroupXpaidOtherClub','GroupXpaidNonMember')
        OR prodgrc.name IN ('Pilates Income','GroupXpaid','GroupXpaidOtherClub','GroupXpaidNonMember'))