            ...
            (
                ...
                LEFT JOIN
                    (
                        SELECT
                            ...
                            CASE
                                WHEN (
                                        ...
                                        AND sp2.SUBSCRIPTION_ID = sp.SUBSCRIPTION_ID
                                            --AND sp2.BINDING = 1
                                        AND sp2.FROM_DATE < least(COALESCE(s.END_DATE,
                            ...
                            CASE
                                WHEN (
                                        ...
                                        AND ( sp2.TO_DATE > s.BILLED_UNTIL_DATE
                                            OR  sp2.TO_DATE IS NULL ) ) = sp.FROM_DATE
                                THEN least(COALESCE(s.END_DATE,params.endDate),params.endDate)
                                ELSE sp.TO_DATE
                            END            AS TO_DATE,
                        ...
                        AND sp.CANCELLED = 0
                            --AND sp.BINDING = 1
                        AND sp.FROM_DATE < least(COALESCE(s.END_DATE,params.endDate),params.endDate
                            )
                        AND (
