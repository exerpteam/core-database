SELECT
	...
	MembershipPrice.TXTVALUE				AS "Membership Price",
...
LEFT JOIN
    PERSON_EXT_ATTRS MembershipPrice
ON
    owner.center = MembershipPrice.PERSONCENTER
    AND owner.id = MembershipPrice.PERSONID
    AND MembershipPrice.name = 'MembershipPrice'
LEFT JOIN
