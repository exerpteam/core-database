WITH
     ...
     (
         ...
         ON
             c.id = p.CENTER
         WHERE
             p.STATUS IN (0,6,9)--lead,prospect,contact
...
AS "Aggregator Name",	
 ...
 staff2.fullname                                                                                                                                                                 AS "Sales Name",
   ...
   CONSENT.TXTVALUE                                                                                                                                                        AS "MarketingConsent",
   DOI.TXTVALUE                                                                                                                                                        AS "DOI",
...
LEFT JOIN
     PERSON_EXT_ATTRS CONSENT
 ON
     p.center=CONSENT.PERSONCENTER
     AND p.id=CONSENT.PERSONID
     AND CONSENT.name='GDPRCONSENT'
