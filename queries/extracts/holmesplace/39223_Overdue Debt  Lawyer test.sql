...
p.blacklisted,
    ...
    (
        ...
        WHERE
            ...
            AND art.REF_TYPE = 'INVOICE') laufzeit_date,
...
LEFT JOIN
	HP.SUBSCRIPTIONS subs
ON
	subs.owner_center = art.CENTER 
	AND subs.OWNER_ID = art.id
	AND subs.sub_state NOT IN (8)
	AND subs.subscriptiontype_id NOT IN (2)
