WITH
    ...
    (
        SELECT
            ...
            DECODE(ccc.CURRENTSTEP_TYPE, -1, 'None', 0, 'Message', 1, 'Reminder', 2, 'Blocked', 3, 'Request and Stop', 4, 'Debt collection', 7, 'Request Buyout and Stop') AS ccc_currentstep_name,
