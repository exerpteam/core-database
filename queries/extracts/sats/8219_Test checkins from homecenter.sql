...
Firstname, 
Lastname, 
persons.center as homecenter, Checkin_Center, TO_DATE('01-01-1970','dd-mm-yyyy ') + Checkin_Time /(24*3600*1000) + 2/24 AS CheckinTime,persons.address1,persons.address2, persons.zipcode, z.city
...
WHERE persons.Center >= :centerFrom  AND 
persons.Center <= :centerTo
AND
