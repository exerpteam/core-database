SELECT
    ...
    NVL(ch."Number of visits Augost",0) "Check-ins Augost",
    ...
    NVL(par."GX participations Augost",0) "GX participations Augost" ,
...
LEFT JOIN
    (
        SELECT
            ...
            SUM(DECODE(extract(MONTH FROM exerpro.longtodate(ch.CHECKIN_TIME)),8,1,0))  AS "Number of visits Augost"
        FROM
            SATS.CHECKINS ch
        JOIN
            persons p1
        ...
        WHERE
            ch.CHECKIN_TIME BETWEEN exerpro.datetolong('2014-01-01 00:00') AND exerpro.datetolong('2015-03-31 23:59')
...
LEFT JOIN
    (
        ...
        ON
            ...
            AND att.START_TIME BETWEEN exerpro.datetolong('2014-01-01 00:00') AND exerpro.datetolong('2015-03-31 23:59')
        JOIN
...
LEFT JOIN
    (
        SELECT
            ...
            SUM(DECODE(extract(MONTH FROM exerpro.longtodate(par.START_TIME)),8,1,0))  AS "GX participations Augost"
        FROM
        ...
        WHERE
            ...
            AND par.START_TIME BETWEEN exerpro.datetolong('2014-01-01 00:00') AND exerpro.datetolong('2015-03-31 23:59')
...
WHERE
    ...
    AND (
        p2.STATUS IN(1,
                     3)
        OR first_sub.END_DATE>to_date('2014-01-01','yyyy-MM-dd') )
GROUP BY
    p2.center,
    p2.id,
    p2.BIRTHDATE,
