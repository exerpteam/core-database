...
-- Used to see if any retail privileges have been used during a period, for which products, the normal price of the product and the discounted price. Summed per product to avoid multiple rows. 
 SELECT
     t1.numberofsales,
     t1.TEXT,
     t1.privname AS name,
