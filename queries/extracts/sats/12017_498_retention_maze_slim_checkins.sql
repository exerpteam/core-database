...
/*    per.SSN, */
    ...
    to_char(sats.longtodate(Checkin_Log.Checkin_Time), 'YYYY-MM-dd')AS CheckinDate,
/*    per.address1,
    per.address2,
    per.zipcode,
    z.city,*/
...
and Checkin_Log.Checkin_Center not in(324,320,323,319,317,711,701,709,708,704,176,145,117,143,105,122,565,528,100,200,250,500,584,590,700,750,252,706,801)
and Checkin_Log.CHECKIN_TIME  >= sats.datetolong(to_char(exerpsysdate() - :Days_back_in_time,'yyyy-mm-dd HH24:MI'))
and Checkin_Log.CHECKIN_TIME <= (sats.datetolong(to_char(exerpsysdate() - 1, 'yyyy-mm-dd HH24:MI'))+ 24*3600*1000)
