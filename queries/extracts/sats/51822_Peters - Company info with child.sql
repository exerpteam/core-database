...
-- Child Company -- 3
  ...
  has_child_company				          AS "Child Company",
...
-- Child Company --      
      ...
      cc.center||'p'||cc.id		         	      AS has_child_company,
...
-- Mother Company --
 ...
 -- Child Company --
    ...
    LEFT JOIN 
      sats.persons cc 
    ON
      cc.CENTER = rel5.RELATIVECENTER AND
      cc.id = rel5.RELATIVEID
...
-- Ext attributes Company --
    ...
    LEFT JOIN
      sats.person_Ext_Attrs Company_phone
    ON
