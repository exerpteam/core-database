 SELECT distinct
    ...
    CASE
             ...
             WHEN art.REF_TYPE = 'ACCOUNT_TRANS' and art.installment_plan_id is not null THEN art.AMOUNT
             WHEN art2.REF_TYPE = 'ACCOUNT_TRANS' and art2.installment_plan_id is null THEN art2.AMOUNT
             ELSE 0
     END AS "TOTAL_AMOUNT", 
         CASE
 ...
 JOIN
         ...
         ON
                 ...
                 and  ((art.REF_TYPE in ('INVOICE','CREDIT_NOTE')) or ( art.REF_TYPE = 'ACCOUNT_TRANS' and art.installment_plan_id is not null and art.amount < 0)) 
 JOIN
         CENTERS center
         ON
                 ap.CENTER = center.ID
 ...
 left JOIN
         ...
         ON
                 ...
                 and  ( art2.REF_TYPE = 'ACCOUNT_TRANS' and art2.installment_plan_id is null )                 
