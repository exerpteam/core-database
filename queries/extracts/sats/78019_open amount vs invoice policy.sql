...
FROM
    (
        SELECT
            dat2.*,
            CASE
                WHEN dat2.creditorId = 'Faktura' and (dat2.TmpInvoicePolicy1 > 0 or dat2.TmpInvoicePolicy1 <= -100) then dat2.TmpInvoicePolicy1
            ...
            /*
            CASE
                WHEN dat2.TmpBalancePolicy2 <= -100
                ...
                FROM
                    (
                        ...
                        JOIN (
                              ...
                              where    art_od.AMOUNT > 0 or (art_od.AMOUNT < 0 and art_od.DUE_DATE < sysdate - 1) group by art_od.center, art_od.id
