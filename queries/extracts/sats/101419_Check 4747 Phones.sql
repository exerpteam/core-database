...
select 
   ...
   replace(pea_home.txtvalue, '+4747', '+47') as new_home,
   pea_mobile.txtvalue as current_mobile,
   replace(pea_mobile.txtvalue, '+4747', '+47') as new_mobile,
   pea_work.txtvalue as current_work,
   replace(pea_work.txtvalue, '+4747', '+47') as new_work
   ...
   where (
   pea_home.txtvalue like '+4747%' or
   pea_mobile.txtvalue like '+4747%' or
   pea_work.txtvalue like '+4747%')
   and p.sex != 'C'
