...
WITH
    ...
    ( 
       SELECT 
          id  as center, 
          CAST(datetolongc(CAST(CURRENT_TIMESTAMP AS TEXT),id) AS BIGINT) - 1000*60*60*24 AS from_time
       FROM centers
    )
,
    p_det AS
    ...
    ( SELECT
        ...
        ,CASE
            ...
            THEN 'Child'
            WHEN bool_or(ppg.product_group_id IN (201, 207, 241)) 
            -- Diamond, Non Countable Diamond, Diamond Plus
            THEN 'Diamond'
