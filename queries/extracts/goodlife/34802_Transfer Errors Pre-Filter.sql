...
WITH
        ...
        (        
                SELECT
                    /*+ materialize */
                    -- datetolongTZ(TO_CHAR(current_date - interval '1 months','YYYY-MM-DD HH24:MI:SS'), c.time_zone)                   AS cutDateOneMonths,
                    -- datetolongTZ(TO_CHAR(current_date - interval '2 months','YYYY-MM-DD HH24:MI:SS'), c.time_zone)                   AS cutDateTwoMonths,
                    -- datetolongTZ(TO_CHAR(current_date - interval '3 months','YYYY-MM-DD HH24:MI:SS'), c.time_zone)                   AS cutDateThreeMonths,
                                                ...
                                                (
                                                        ...
                                                        (
                                                            ...
                                                            /*
                                                               ...
                                                               AND NOT EXISTS ( -- $0 Subscriptions
                                                                                                SELECT
                                                                                                        *
                                                                                                FROM goodlife.subscriptions s 
                                                                   
                                                                                                JOIN    goodlife.product_and_product_group_link ppl 
                                                                                                        ON s.subscriptiontype_center = ppl.product_center 
