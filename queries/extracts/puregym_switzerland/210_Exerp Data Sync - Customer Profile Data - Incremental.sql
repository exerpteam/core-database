...
WITH
    ...
    (
        SELECT
            datetolongTZ(TO_CHAR(date_trunc('day', CURRENT_DATE)- INTERVAL '2 days', 'YYYY-MM-DD HH24:MI'), 'Europe/Zurich')::bigint AS FROMDATE,
            datetolongTZ(TO_CHAR(date_trunc('day', CURRENT_DATE+INTERVAL '1 days'), 'YYYY-MM-DD HH24:MI'), 'Europe/Zurich')::bigint AS TODATE
    )
SELECT
    "MEMBERNO",
    "PCENTER",
