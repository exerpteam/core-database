 SELECT
   ...
   , TO_CHAR(longtodateTZ(ci.CHECKIN_TIME, 'Europe/Zurich'),'YYYY/MM/dd HH24:MI')        AS "Date & time in"
   , TO_CHAR(longtodateTZ(ci.CHECKOUT_TIME, 'Europe/Zurich'),'YYYY/MM/dd HH24:MI')       AS "Date & time out"
 ...
 SELECT
     p.CURRENT_PERSON_CENTER                                                             AS "Member home centre"
   , p.CURRENT_PERSON_CENTER ||'p'|| p.CURRENT_PERSON_ID                                 AS "Member id"
   , TO_CHAR(longtodateTZ(ou.TIMESTAMP, 'Europe/Zurich'),'YYYY/MM/dd HH24:MI')        AS "Date & time in"
