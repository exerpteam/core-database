...
AND il.subid = ilv.invoiceline_subid
        ...
        GROUP BY
            ...
            pr.state
        UNION ALL
		         /* NEW SECTION - ADYEN PAYMENT REQUESTS SENT*/
        SELECT
            pr.center,
            TO_CHAR(pr.REQ_DATE, 'yyyy-mm-dd') "text",
            -COUNT(*)                                           COUNT,
        ...
        GROUP BY
            ...
            pr.REQ_DATE
        UNION ALL
		  /* NEW SECTION - ADYEN PAYMENT REQUESTS STATUS*/
        SELECT
            pr.center,
            TO_CHAR(pr.REQ_DATE, 'yyyy-mm-dd') "text",
            COUNT(*)                                             COUNT,
        ...
        GROUP BY
            ...
            pr.state
        UNION ALL
		        /* NEW SECTION - ADYEN UNPAID REASON CODES */
        SELECT
            pr.center,
            pr.XFR_INFO "text",
            COUNT(*)                     COUNT,
        ...
        GROUP BY
            ...
            pr.XFR_INFO
        UNION ALL
		        /* NEW SECTION - ADYEN REPRESENTATIONS SENT*/
        SELECT
            pr.center,
            TO_CHAR(pr.REQ_DATE, 'yyyy-mm-dd') "text",
            -COUNT(*)                                           COUNT,
        ...
        GROUP BY
            ...
            pr.REQ_DATE
		UNION ALL
        /* NEW SECTION - ADYEN REPRESENTATIONS STATUS*/
        SELECT
            pr.center,
            TO_CHAR(pr.REQ_DATE, 'yyyy-mm-dd') "text",
            COUNT(*)                                             COUNT,
