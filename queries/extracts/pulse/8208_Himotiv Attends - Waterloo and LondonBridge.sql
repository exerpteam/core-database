...
ON
    brg.ID = brc.GROUP_ID
WHERE
    att.START_TIME BETWEEN datetolong(TO_CHAR(TRUNC(SYSDATE -7), 'YYYY-MM-DD HH24:MI')) AND datetolong(TO_CHAR(TRUNC(SYSDATE), 'YYYY-MM-DD HH24:MI')) and att.center in (304,310)