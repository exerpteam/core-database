 SELECT
     ...
     CASE ST_TYPE WHEN 0 THEN 'Cash' WHEN 1 THEN 'EFT' WHEN 2 THEN 'Clipcard' WHEN 3 THEN 'Course' END as SUBSCRIPTION_CATEGORY,
     ...
     scStop.EMPCENTER ||'emp'|| scStop.EMPID as           employeeid,
         ...
         FROM
             (
                 SELECT
                     ...
                     scStopstaff.CENTER,
                     scStopstaff.ID,
                     escStopEmp.center as EMPCENTER,
                     escStopEmp.id as EMPID,
                      CASE
