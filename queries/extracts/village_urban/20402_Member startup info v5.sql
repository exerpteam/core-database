...
where ch2.person_center = params.center_id 
and ch2.CHECKIN_RESULT < 3  
and s2.start_date >= params.fromDate
and s2.start_date <= params.toDate                        
...
where ch3.person_center = params.center_id 
and ch3.CHECKIN_RESULT < 3  
and s3.start_date >= params.fromDate
and s3.start_date <= params.toDate
and params.fromDateLong <= ch3.checkin_time 
...
and STATUSES2.person_id   = pt.id                        
           ...
           p.center = params.center_id
                  ...
                  and s.start_date >= params.fromDate
                  and s.start_date <= params.toDate
                  and ((bo.starttime >= params.fromDateLong) or (bo.starttime is null))
