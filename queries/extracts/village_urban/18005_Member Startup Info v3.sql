...
and ch2.CHECKIN_RESULT < 3  
and p2.first_active_start_date >= (:datefrom)
and p2.first_active_start_date <= (:dateto)                        
...
and ch3.CHECKIN_RESULT < 3  
and p3.first_active_start_date >= (:datefrom)
and p3.first_active_start_date <= (:dateto)   
...
and STATUSES2.person_id   = pt.id                        
           ...
           p.center in (:center)
                     ...
                     p.status IN (0,1,2,3)
                  and p.first_active_start_date >= (:datefrom)
                  and p.first_active_start_date <= (:dateto) 
