...
SELECT
    ...
    TO_CHAR(longtodatetz(MIN(DECODE(br.EXTERNAL_ID,343,att.START_TIME,351,att.START_TIME,NULL)),'Europe/London'),'dd-MM-yyyy HH24:MI') AS "Attend date/time In",
    TO_CHAR(longtodatetz(MAX(DECODE(br.EXTERNAL_ID,344,att.START_TIME,347,att.START_TIME,NULL)),'Europe/London'),'dd-MM-yyyy HH24:MI') AS "Attend date/time Out",
