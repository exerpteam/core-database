...
SELECT
    ...
    TO_CHAR(longtodatetz(MIN(DECODE(br.EXTERNAL_ID,415,att.START_TIME,416,att.START_TIME,NULL)),'Europe/London'),'dd-MM-yyyy HH24:MI') AS "Attend date/time In",
    TO_CHAR(longtodatetz(MAX(DECODE(br.EXTERNAL_ID,421,att.START_TIME,419,att.START_TIME,NULL)),'Europe/London'),'dd-MM-yyyy HH24:MI') AS "Attend date/time Out",
