...
SELECT
    ...
    CASE
        ...
        WHEN je.NAME LIKE '%Courses - Ladies Only Purchase Sage Pay'
        THEN REPLACE(je.NAME, 'Purchase Sage Pay','')  
    ...
    AND 
        (   
                je.NAME IN ('Debts Payment Sage Pay',
                 ...
                 OR
                        je.NAME LIKE '%Course Purchase Sage Pay'
OR 
je.NAME LIKE '%Courses - Ladies Only Purchase Sage Page'
          )
                        ...
                        WHERE
                            (   
                                ClosestJE.NAME IN ('Debts Payment Sage Pay',
                                 ...
                                 OR
                                        ClosestJE.NAME LIKE '%Course Purchase Sage Pay'
OR 
je.NAME LIKE '%Courses - Ladies Only Purchase Sage Page'
                             )
