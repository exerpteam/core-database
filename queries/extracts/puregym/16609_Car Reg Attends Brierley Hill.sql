...
SELECT
    ...
    TO_CHAR(longtodatetz(MIN(DECODE(br.EXTERNAL_ID,440,att.START_TIME,447,att.START_TIME,NULL)),'Europe/London'),'dd-MM-yyyy HH24:MI') AS "Attend date/time In",
    TO_CHAR(longtodatetz(MAX(DECODE(br.EXTERNAL_ID,444,att.START_TIME,446,att.START_TIME,NULL)),'Europe/London'),'dd-MM-yyyy HH24:MI') AS "Attend date/time Out",
