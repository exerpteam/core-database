...
SELECT
    ...
    TO_CHAR(longtodatetz(MIN(DECODE(br.EXTERNAL_ID,1042,att.START_TIME,1035,att.START_TIME,NULL)),'Europe/London'),'dd-MM-yyyy HH24:MI') AS "Attend date/time In",
    TO_CHAR(longtodatetz(MAX(DECODE(br.EXTERNAL_ID,1036,att.START_TIME,1043,att.START_TIME,NULL)),'Europe/London'),'dd-MM-yyyy HH24:MI') AS "Attend date/time Out",
