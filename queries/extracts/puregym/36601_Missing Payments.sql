...
-- https://clublead.atlassian.net/browse/ST-1870
    ...
    */
    ...
    (
        ...
        HAVING
            COUNT(1) = 6)
    /*
    ST-1870: The member should have some kind of phone number
    */
    AND EXISTS
    (
        SELECT
        ...
        WHERE
            ...
            AND ((atts.NAME = '_eClub_PhoneSMS' and length(atts.TXTVALUE ) > 0)
            or (atts.NAME = '_eClub_PhoneHome' and length(atts.TXTVALUE ) > 0)) )
    /*
