...
SELECT
    ...
    TO_CHAR(longtodatetz(MIN(DECODE(br.EXTERNAL_ID,1093,att.START_TIME,1091,att.START_TIME,NULL)),'Europe/London'),'dd-MM-yyyy HH24:MI') AS "Attend date/time In",
    TO_CHAR(longtodatetz(MAX(DECODE(br.EXTERNAL_ID,1086,att.START_TIME,1084,att.START_TIME,NULL)),'Europe/London'),'dd-MM-yyyy HH24:MI') AS "Attend date/time Out",
