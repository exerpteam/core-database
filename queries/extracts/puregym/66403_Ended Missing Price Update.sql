 ...
 (
         SELECT
                 t3.*,
                                 t3.OWNER_CENTER || 'p' || t3.OWNER_ID AS PERSONID,
                 sp.PRICE AS FUTURE_PRICE,
                                 TO_CHAR(t3.START_OVERLAP + t3.OVERLAP,'YYYY-MM-DD') AS FUTURE_PRICE_START_DATE,
                                 longtodatec(acl.entry_time, t3.OWNER_CENTER) AS AgreementChangedEntryTime,
                                  CASE pag.STATE
                                         WHEN 5
                                         THEN 'Ended, bank'
                                         WHEN 6
                                 ...
                                 acl.text AS AgreementChangeText,
                 ...
                 (
                         ...
                         (
                                 ...
                                 FROM
                                     SUBSCRIPTIONS s
                                 JOIN 
                                     PERSONS p ON s.OWNER_CENTER = p.CENTER AND s.OWNER_ID = p.ID AND p.PERSONTYPE != 4
                                 JOIN
         ...
         JOIN SUBSCRIPTION_PRICE sp
                 ...
                 ON
                         ar.customercenter = t3.owner_center
                         AND ar.customerid = t3.owner_id
                         AND ar.ar_type = 4
                 JOIN
                         PAYMENT_ACCOUNTS pa
                 ON
                 ...
                 ON
                         ...
                         AND acl.entry_time > datetolongTZ(TO_CHAR(t3.PARAM_END_DATE, 'YYYY-MM-dd HH24:MI'), 'Europe/London')
 ) t4
 where rnk = 1
