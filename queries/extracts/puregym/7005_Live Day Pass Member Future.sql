SELECT DISTINCT
    ...
    s.START_DATE,
    s.END_DATE,
    DECODE (p.STATUS, 0,'LEAD', 1,'ACTIVE', 2,'INACTIVE', 3,'TEMPORARYINACTIVE', 4,'TRANSFERED', 5,'DUPLICATE', 6,'PROSPECT', 7,'DELETED',8, 'ANONYMIZED', 9, 'CONTACT', 'UNKNOWN') AS STATUS, p.external_id
FROM
    PERSONS P
LEFT JOIN
    person_ext_attrs ph
