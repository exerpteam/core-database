...
SELECT
    ...
    DECODE(pea.PUREGYMATHOME_TXTVALUE,'true',1,0)                                                                                                                                   AS "PUREGYMTOGETHER",
            ...
            (
                ...
                WHERE
                    pea.NAME IN ( '_eClub_HasLoggedInMemberMobileApp',
                             ...
                             'DISABLED_ACCESS',
                             'PUREGYMATHOME'
                              ) ) PIVOT ( MAX(LAST_EDIT_TIME) AS LAST_EDIT_TIME, MAX(TXTVALUE) AS TXTVALUE FOR NAME IN ( '_eClub_HasLoggedInMemberMobileApp' AS APPLOGIN,
																																			  ...
																																			  'ErasureRequest'                     AS ERASUREREQUEST,
                                                                                                                                              'DISABLED_ACCESS'                    AS DISABLEDACCESS,
                                                                                                                                              'PUREGYMATHOME'                      AS PUREGYMATHOME) ) ) pea
ON
