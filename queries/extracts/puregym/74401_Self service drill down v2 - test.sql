 ...
 WITH
         ...
         FROM
             (
                 ...
                 WHERE
                     ...
                     /* Changes made by employee at center 100 and not 100emp1 */
                     AND sfp.cancel_employee_id = 34402
         ...
         FROM
             (
                 ...
                 WHERE
                     ...
                     AND v_bank.IS_CHANGE = 1 ) t3
         WHERE
             rnk = 1
             AND employee_center = 100
             /* Changes made by employee at center 100 and not 100emp1 */
             AND employee_id = 34402
             /* Member should be active during time of change */
             AND EXISTS
             (
                 SELECT
     ...
     (
         ...
         WHERE
             ...
             /* Changes made by employee at center 100 and not 100emp1 */
             AND sa.employee_creator_id = 34402
