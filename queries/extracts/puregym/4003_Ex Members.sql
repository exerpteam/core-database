...
-- https://clublead.atlassian.net/browse/ST-1871
...
SELECT distinct
    ...
    CASE
        ...
        THEN current_date - P.LAST_ACTIVE_START_DATE + 1
        ELSE P.MEMBERDAYS
    END "Unbroken membership days",
    CASE
        WHEN P.LAST_ACTIVE_END_DATE IS NULL
        THEN current_date - P.LAST_ACTIVE_START_DATE + 1 + P.ACCUMULATED_MEMBERDAYS
