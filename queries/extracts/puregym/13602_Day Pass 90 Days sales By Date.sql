...
GROUP BY
    ...
    END ,
    a.NAME ,
    DECODE(a.NAME,'Justin Way',1,'Graeme Penny',2,'Jake Rostron',3,'Matt Buckley',4,'Johanna Brogan',5,'Matt Tomlinson',6,'Naj Chekara',7,'Malcom Armstrong',8,'Barry Ashby',9,'Andrew Ingham',10,'John Maddox',11,'Jacqui Pope',12)