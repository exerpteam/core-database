...
-- https://clublead.atlassian.net/browse/ST-9553
 SELECT
     P.CENTER||'p'||P.ID                                                              AS "Company Id",
     P.FULLNAME                                                                       AS "Company Name",
     CASE pag.clearinghouse  WHEN 1 THEN  'Direct Debit'  WHEN 401 THEN  'Invoice'  WHEN 201 THEN  'Credit Card' END AS "Payment Method",
