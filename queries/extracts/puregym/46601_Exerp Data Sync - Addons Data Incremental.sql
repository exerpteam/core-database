...
-- https://clublead.atlassian.net/browse/ST-3393
 WITH
    PARAMS AS
    (
     SELECT
         /*+ materialize  */
         datetolongTZ(TO_CHAR(TRUNC(CURRENT_TIMESTAMP)-10, 'YYYY-MM-DD HH24:MI'), 'Europe/London') AS FROMDATE,
         datetolongTZ(TO_CHAR(TRUNC(CURRENT_TIMESTAMP+1), 'YYYY-MM-DD HH24:MI'), 'Europe/London') AS TODATE
