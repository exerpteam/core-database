...
WHERE
    ...
    sc.EFFECT_DATE >= (LAST_DAY(longtodateTZ(params.datetime, 'Europe/London')) + 1)
    AND sc.EFFECT_DATE < (LAST_DAY(ADD_MONTHS(longtodateTZ(params.datetime, 'Europe/London'),1)) + 1)
