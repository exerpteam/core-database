 ...
 (
         SELECT
                 mpr.ID,
                 unnest(xpath('//subscriptionType/freeze/period/product/prices/price/normalPrice/text()',xmlparse(document convert_from(mpr.product, 'UTF-8')))) as freezePrice,
                 unnest(xpath('/subscriptionType/freeze/period/product/prices/price/@start',xmlparse(document convert_from(mpr.product, 'UTF-8'))))  as freezePriceStart,
                 mpr.GLOBALID,
