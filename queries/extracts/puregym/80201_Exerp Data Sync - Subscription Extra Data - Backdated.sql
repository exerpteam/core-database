...
-- Single use extract for backdating sub extra data missed due to MD import failures.
WITH
    params AS materialized
    (
        SELECT
            datetolongC(TO_CHAR(make_date(2023, 1, 9), 'YYYY-MM-DD HH24:MI'), 100)::bigint AS FROMDATE,
    ...
    (
        CASE
            ...
            ELSE TO_CHAR(longtodatetz(GREATEST(LAST_MODIFIED, Freeze_Last_Modified,
                Boltons_Last_Created),'Europe/London'),'YYYY-MM-DD HH24:MI:SS')
