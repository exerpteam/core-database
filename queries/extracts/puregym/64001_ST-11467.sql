 ...
 WITH
     ...
     (
         SELECT
             ...
             TO_DATE('2021-05-31','YYYY-MM-DD') AS EndDate,
             0                                  AS numberOfDays
 ...
 LEFT JOIN    SUBSCRIPTION_PRICE sp
         ON sp.SUBSCRIPTION_CENTER = t1.SubCenter AND sp.SUBSCRIPTION_ID = t1.SubId AND sp.FROM_DATE >= :PriceUpdateDate AND sp.CANCELLED = 0
 GROUP BY
         t1.NAME,
         t1.CAMPAIGN_NAME,
         t1.PRIV_USAGE_STATE,
