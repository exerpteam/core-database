...
-- https://clublead.atlassian.net/browse/ST-3862
 ...
 WHERE
     ci.CHECKIN_TIME >= (TRUNC(CURRENT_TIMESTAMP)-$$offset$$-to_date('1-1-1970 00:00:00','MM-DD-YYYY HH24:Mi:SS'))*24*3600*1000
     AND ci.CHECKIN_TIME < (TRUNC(CURRENT_TIMESTAMP+1)-to_date('1-1-1970 00:00:00','MM-DD-YYYY HH24:Mi:SS'))*24*3600*1000
 ...
 ON
     ...
     AND prod.ID = s.SUBSCRIPTIONTYPE_ID
 WHERE
     ou.TIMESTAMP >= (TRUNC(CURRENT_TIMESTAMP)-$$offset$$-to_date('1-1-1970 00:00:00','MM-DD-YYYY HH24:Mi:SS'))*24*3600*1000
     AND ou.TIMESTAMP < (TRUNC(CURRENT_TIMESTAMP+1)-to_date('1-1-1970 00:00:00','MM-DD-YYYY HH24:Mi:SS'))*24*3600*1000
     ...
     WHERE
        ...
        AND c.CHECKIN_TIME >= (TRUNC(CURRENT_TIMESTAMP)-$$offset$$-to_date('1-1-1970 00:00:00','MM-DD-YYYY HH24:Mi:SS'))*24*3600*1000
        AND c.CHECKIN_TIME < (TRUNC(CURRENT_TIMESTAMP+1)-to_date('1-1-1970 00:00:00','MM-DD-YYYY HH24:Mi:SS'))*24*3600*1000
