  WITH
    ...
    (
     SELECT
         datetolongTZ(TO_CHAR(date_trunc('day',CURRENT_TIMESTAMP-INTERVAL '10 days'), 'YYYY-MM-DD HH24:MI'), 'Europe/London')::bigint AS FROMDATE,
         datetolongTZ(TO_CHAR(date_trunc('day',CURRENT_TIMESTAMP+ INTERVAL '1 day'), 'YYYY-MM-DD HH24:MI'), 'Europe/London')::bigint AS TODATE
    )
 SELECT
         distinct
