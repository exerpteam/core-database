...
-- https://clublead.atlassian.net/browse/ST-11496
 ...
 srd.employee_center || 'emp' || srd.employee_id AS "Free Created Employee",
     ...
     s.ID,
     srd.ID AS FP_KEY,
     lc.OpeningDate - 1 AS NEW_FREE_STOP_DATE
 FROM
     persons p
 ...
 ON
     ...
     AND srd.end_date >= lc.OpeningDate
 LEFT JOIN
