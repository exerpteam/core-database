WITH
    ...
    (
        SELECT
            datetolongTZ(TO_CHAR(date_trunc('day', CURRENT_DATE)- INTERVAL '2 days', 'YYYY-MM-DD HH24:MI'), 'Europe/London')::bigint    AS FROMDATE,
            datetolongTZ(TO_CHAR(date_trunc('day', CURRENT_DATE+INTERVAL '1 days'), 'YYYY-MM-DD HH24:MI'), 'Europe/London')::bigint     AS TODATE
    )
SELECT
    "MEMBERNO",
    "PCENTER",
    "PID",
    selection.EXTERNAL_ID::VARCHAR                                                                  AS "EXTERNALID",
    "FIRSTNAME",
    "LASTNAME",
    "BIRTHDATE",
    "GENDER",
    ...
    CASE pea.ALLOWSURVEY_TXTVALUE
        ...
        ELSE 0
    END                                                                                             AS "ALLOWSURVEY",
    TO_CHAR (longtodatetz (pea.ALLOWSURVEY_LAST_EDIT_TIME, 'Europe/London'), 'YYYY-MM-DD HH24:MI:SS') AS "ALLOWSURVEYDATE",
...
(
    ...
    AND b_prod.GLOBALID = 'BUDDY_SUBSCRIPTION'
