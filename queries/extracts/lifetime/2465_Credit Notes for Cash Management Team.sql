...
DatetoLongC(to_char(to_date(:Transaction_Start_Date,'YYYY-MM-DD'),'YYYY-MM-DD HH24:MI:SS'), cn.center) 
AND	DatetoLongC(to_char(to_date(:Transaction_End_Date,'YYYY-MM-DD'),'YYYY-MM-DD HH24:MI:SS'), cn.center)+86399999