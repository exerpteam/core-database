...
(
        SELECT  
                ...
                (CASE
                        WHEN (xmlexists('//subscriptionType/prorataPeriod/period/text()' PASSING BY REF pmp_xml.pxml)) THEN
                                UNNEST(xpath('//subscriptionType/prorataPeriod/period/text()', pmp_xml.pxml))         
                        ELSE
                                NULL
                END) AS prorataPeriod,
                (CASE
