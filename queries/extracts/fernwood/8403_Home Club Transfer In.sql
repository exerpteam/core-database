...
-- https://clublead.atlassian.net/browse/ST-13243
https://clublead.atlassian.net/jira/servicedesk/projects/EC/queues/custom/130/EC-869
SELECT
...
JOIN
        subscriptions olds
				...
				AND CAST((olds.end_date + 1) AS varchar) = trd.txtvalue
LEFT JOIN
        products pold
