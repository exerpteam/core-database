WITH params AS (
    SELECT
        datetolongC('2026-01-01 00:00', c.id) AS FromDate,
        c.id AS center_id,
        CAST(datetolongC('2026-01-31 00:00', c.id) - 1 AS BIGINT) AS ToDate
    FROM centers c
),
...
SELECT
    SUM(
        CASE 
            WHEN t."Cost Center" IN ('02.00.4100.1-FIIT30 Membership', '118.4100-FIIT30 Membership', '146.4100.1-FIIT30 Membership', '158.4100.1-FIIT30 Membership', '145.4100.1-FIIT30 Membership', '103.4100.1-FIIT30 Membership', '130.4100.1-FIIT30 Membership') THEN t."Amount" * 0.5
            WHEN t."Cost Center" IN ('02.00.4114.2-Platinum incl FIIT30 Reformer Membership', '02.00.4114.10-Platinum incl FIIT30 Reformer Membership') THEN t."Amount" * 0.3
            ELSE t."Amount"
        END
    ) AS "Total Inclusive GST",
...
WHERE
    t."Cost Center" IN (
        '02.00.4100.1-FIIT30 Membership', '02.00.4212-Income FIIT30', '103.4212-Income FIIT30', '118.4212-Income FIIT30',
        '130.4212-Income FIIT30', '145.4212-Income FIIT30', '146.4212-Income FIIT30', '158.4212-Income FIIT30',
        '200.1-Income FIIT30', '2030-Income FIIT30', '203-Income FIIT30', '206-Income FIIT30', '207-Income FIIT30',
        '40041-Income FIIT30', '40070-Income FIIT30', '4-0111-Income FIIT30', '41012-Income FIIT30', '4103-Income FIIT30',
        '4-1040-Income FIIT30', '41100-Income FIIT30', '41103-Income FIIT30', '4-1110-Income FIIT30', '4-1150-Income FIIT30',
        '41150-Income FIIT30', '41215-Income FIIT30', '41300-Income FIIT30', '4-2000-Income FIIT30', '43000-Income FIIT30',
        '44118-Income FIIT30', '44500-Income FIIT30', '4-9015-Income FIIT30',
        '02.00.4114.2-Platinum incl FIIT30 Reformer Membership', '118.4100-FIIT30 Membership', '146.4100.1-FIIT30 Membership',
        '158.4100.1-FIIT30 Membership', '02.00.4114.10-Platinum incl FIIT30 Reformer Membership', '145.4100.1-FIIT30 Membership',
        '103.4100.1-FIIT30 Membership', '130.4100.1-FIIT30 Membership'
    )
  AND t."Cost Center" NOT IN (
        '02.00.1200-Bank account: EFT', '02.00.1212.1-Account Receivables: EFT account (persons)', '02.00.1280.4-Cash register interim',
        '02.00.1281-Account Receivables: Cash account', '02.00.1282.1-Account Receivables: External debt account',
        '02.00.1283-Account Receivables: Installment plan account', '02.00.1200.1-Bank account: credit card',
        '02.00.1240.1-Inventory Adjustment'
    )
...
GROUP BY t."Cost Center", t."Club ID", t."Club Name";
