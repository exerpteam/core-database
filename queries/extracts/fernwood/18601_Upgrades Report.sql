...
-- https://clublead.atlassian.net/browse/ST-13016
https://clublead.atlassian.net/browse/EC-800
https://clublead.atlassian.net/browse/EC-4661
https://clublead.atlassian.net/browse/EC-5110
https://clublead.atlassian.net/browse/EC-7195
WITH
...
(
        SELECT
                TO_CHAR(longtodateC(t3.Visit,t3.center),'DD/MM/YYYY') AS "Visit Date" 
                ,t3.center
                ,t3.id
...
,TO_CHAR(longtodateC(s.creation_time, s.center), 'DD/MM/YYYY') AS "Purchase Date"
...
,TO_CHAR(longtodateC(sao.creation_time, sao.center_id), 'DD/MM/YYYY') AS "Purchase Date"
                                                                ,pemp.fullname || ' (' || emp.center || 'emp' || emp.id || ')' AS "Staff Member"
...
,TO_CHAR(longtodateC(inv.trans_time, inv.center), 'DD/MM/YYYY') AS "Purchase Date"
                                                                ,pemp.fullname || ' (' || emp.center || 'emp' || emp.id || ')' AS "Staff Member"
                                                                ,pemps.fullname || ' (' || emps.center || 'emp' || emps.id || ')' AS "Sold on behalf of"
                                                                ,CASE
                                                                        WHEN pgf.product_group = 'Challenges' THEN ''
