...
-- This report includes sessions that trainers have given to members where the member did not have a clip available to use, effectively giving the member a free session. These sessions are marked as NO PRIVILEDGE in the report. 
WITH
  params AS
  (
      SELECT
