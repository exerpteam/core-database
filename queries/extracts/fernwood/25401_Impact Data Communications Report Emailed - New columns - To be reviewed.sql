...
SELECT   
        ...
        ,CASE
                WHEN email.txtvalue IS NOT NULL THEN 'email available'
                ELSE 'no email'
        END AS Email
        ,CASE
                WHEN mobile.txtvalue IS NOT NULL THEN 'phone number available'
...
WHERE
        ...
        AND
        p.center NOT IN (601,303,204,305,102,702,206,309,311,602,314,320,321,322,105,11,314)     
