...
WITH
    ...
    (
        ...
        WHERE
            ...
            -- FIIT30 Strong Start (double-dash safe)
...
SELECT
    ...
    exerp_person_id AS "Exerp Person ID",
    member_name AS "Member Name",
    class_name AS "Class Name",
    class_date AS "Class Date",
    class_time AS "Class Time"
FROM base_attendance
ORDER BY club_name, class_date, class_time, member_name;
