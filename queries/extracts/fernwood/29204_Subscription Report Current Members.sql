...
SELECT
	...
	TO_CHAR(p.birthdate, 'DD/MM/YYYY') AS "Birth Date",
...
GROUP BY
    ...
    p.firstname, p.lastname, p.address1, p.city, p.zipcode,
    p.birthdate, peeaHome.txtvalue, peeaMobile.txtvalue, peeaEmail.txtvalue,
    p.first_active_start_date, p.last_active_start_date, p.last_active_end_date,
