...
transaction_data AS (
    SELECT 
        ...
        CASE
            WHEN income.external_id IS NOT NULL THEN income.external_id || '-' || income.name
...
SELECT
    ...
    ROUND(
        CASE 
            WHEN t."Cost Center" IN ('02.00.4100.1-FIIT30 Membership', '118.4100-FIIT30 Membership', '146.4100.1-FIIT30 Membership',
                                      '158.4100.1-FIIT30 Membership', '145.4100.1-FIIT30 Membership', '103.4100.1-FIIT30 Membership',
                                      '130.4100.1-FIIT30 Membership')
                THEN t."Amount" * 0.5
            WHEN t."Cost Center" IN ('02.00.4114.2-Platinum incl FIIT30 Reformer Membership',
                                       '02.00.4114.10-Platinum incl FIIT30 Reformer Membership')
                THEN t."Amount" * 0.3
            ELSE t."Amount"
        END
    , 2) AS "Total Inclusive GST",
    ...
    ROUND(
        CASE 
            WHEN t."Cost Center" IN ('02.00.4100.1-FIIT30 Membership', '118.4100-FIIT30 Membership', '146.4100.1-FIIT30 Membership',
                                      '158.4100.1-FIIT30 Membership', '145.4100.1-FIIT30 Membership', '103.4100.1-FIIT30 Membership',
                                      '130.4100.1-FIIT30 Membership')
                THEN t."Amount" * 0.5 / 1.1
            WHEN t."Cost Center" IN ('02.00.4114.2-Platinum incl FIIT30 Reformer Membership',
                                       '02.00.4114.10-Platinum incl FIIT30 Reformer Membership')
                THEN t."Amount" * 0.3 / 1.1
            ELSE t."Amount" / 1.1
        END
    , 2) AS "Total Exclusive GST",
