...
ON
	...
	AND emp.ID = er.ID
	AND er.ROLEID IN (7352, 7355, 7356, 7357, 7359, 7360, 7362, 7353, 7354, 7361, 7358, 7545, 10053)
Left Join Centers
On
...
ON
	er.ROLEID = r.ID
--	AND r.ID IN (7352, 7355, 7356, 7357, 7359, 7360, 7362, 7353, 7354, 7361, 7358, 7545, 10053)
