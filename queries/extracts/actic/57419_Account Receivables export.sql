...
SELECT DISTINCT
    ...
    NULL                      AS AccountBalanceDueDate, -- exerp to exerp migrations ahve due dates
    ...
    pa.bank_account_holder                                      AS
                PaymentAgreementBankAccountHolder,
...
ON
    account.CUSTOMERCENTER=p.center
AND account.CUSTOMERID=p.id
...
AND acl.STATE > 4
    join clearinghouses cl on cl.id = pa.clearinghouse
JOIN
