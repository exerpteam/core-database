...
WITH
    ...
    (
        SELECT
				...
				datetolongTZ(TO_CHAR(TRUNC(ADD_MONTHS(LAST_DAY(to_date(getcentertime(100), 'YYYY-MM-DD HH24:MI'))-90,-90)), 'YYYY-MM-DD HH24:MI'),'Europe/Stockholm') AS periodFromLong,
...
or (cn.CASHREGISTER_CENTER = 100 and per.center = $$center$$ AND CN.ENTRY_TIME >= :datefrom
                AND CN.ENTRY_TIME < params.periodToLong)
		AND NOT EXISTS
            (
                SELECT
