...
SELECT DISTINCT
    ...
    DECODE(sc2.ID,NULL,NULL,sp.FROM_DATE)    discounted_period_start,
    DECODE(sc2.ID,NULL,NULL,sp.TO_DATE)      discounted_period_end,
    DECODE(sc2.ID,NULL,NULL,sp.PRICE)        discounted_period_price,
...
WHERE
    ...
    AND s.CREATION_TIME > $$SalesFromDate$$
    AND s.CREATION_TIME <$$SalesToDate$$+1000*60*60*24
