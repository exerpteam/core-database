...
--  
SELECT DISTINCT P.CENTER AS CENTER, P.ID AS ID, p.ssn, P.FULLNAME AS FULLNAME, 
        CE.NAME AS CENTER, PE1.LASTNAME AS COMPANYNAME, 
PE2.EXTERNAL_ID 
    ...
    join PERSON_EXT_ATTRS PEA3 ON (PEA3.PERSONCENTER = 
        ...
        AND PEA3.NAME = '_eClub_Email')  WHERE P.CENTER IN (:Scope) AND P.PERSONTYPE =  2 
