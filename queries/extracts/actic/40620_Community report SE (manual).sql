...
* This should be converted to a Jasper report and presented in the Exerp Report App. 
* Note: Automated extract exist, this is a complement with the possibility for manual timeinterval. 
*
*/
WITH
    params AS
...
JOIN
    ...
    (
        ...
        WHERE
			...
			AND prod.GLOBALID != 'ONLINE_DIGITAL_MEMBERSHIP'
            AND NOT EXISTS
            (
                SELECT
                    *
