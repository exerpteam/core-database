...
WHERE 
	...
	AND prod.globalid NOT LIKE 'CASH_12_M_FLEXPAY'
	AND prod.globalid NOT LIKE 'CASH_12_M_FLEXPAY_LOCAL_AREA' 
	AND prod.globalid NOT LIKE 'CAS_12_M_AREA_FLEXPAY' 
	AND prod.globalid NOT LIKE 'CASH_12_M_SWIMMING_FLEXPAY' 
	AND st.ST_TYPE = '0'
	AND sub.SUB_STATE = '1'
	AND floor(months_between(exerpsysdate(), p.birthdate) / 12) >= 18
	AND cen.COUNTRY = 'SE'
	AND cen.ID NOT IN (152, 33, 12, 183, 158, 9219, 9220, 9221) 
