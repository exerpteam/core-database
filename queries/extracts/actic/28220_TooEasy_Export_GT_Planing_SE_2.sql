...
(528, 84078))
   ...
   --AND bk.STARTTIME >= FromDate
	...
	AND bk.STARTTIME >= datetolong(TO_CHAR(TRUNC(current_timestamp +16), 'YYYY-MM-DD HH24:MI')) -- yesterday at midnight
	AND bk.STARTTIME < datetolong(TO_CHAR(TRUNC(current_timestamp +31), 'YYYY-MM-DD HH24:MI')) + 86399*1000 -- yesterday at midnight +24 hours --in ms
