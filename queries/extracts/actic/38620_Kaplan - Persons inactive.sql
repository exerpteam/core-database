SELECT DISTINCT
	...
	p.FIRST_ACTIVE_START_DATE As FirstActiveStartDate,
	p.LAST_ACTIVE_END_DATE As LastActiveDate,
	sub.STATE As Status,
...
WHERE
	p.CENTER IN (:Scope)
	AND sub.END_DATE >= date '2019-01-31'
	AND sub.BINDING_END_DATE <= date '2019-12-04'
	AND p.LAST_ACTIVE_END_DATE IS NOT NULL
