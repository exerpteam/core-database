SELECT
        ...
        to_char(prs.ORIGINAL_DUE_DATE, 'DD-MM-YY') AS "DUE_DATE",
		to_char(exerpsysdate()+3, 'DD-MM-YY') AS "NEW_DUE_DATE",
...
WHERE 
        prs.ORIGINAL_DUE_DATE BETWEEN trunc(exerpsysdate()-15) AND trunc(exerpsysdate()-1)
        AND pr.REQ_AMOUNT > 0
