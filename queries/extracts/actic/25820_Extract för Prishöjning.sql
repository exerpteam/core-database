...
WHERE
	sub.OWNER_CENTER IN (136,33,189,200,197,50,178,9,16,9219,9220,9221,133,49,157,8,154,163,18,24,77,139,150,181,29,175,23,193,13,110,196,199,188,183,20,68)
	------------------	
...
AND sub.BINDING_END_DATE < (exerpsysdate())
AND st.ST_TYPE = 1
AND sub.STATE NOT IN (3)
