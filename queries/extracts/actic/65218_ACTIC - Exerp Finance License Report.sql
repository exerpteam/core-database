...
/* LIFE TIME only, replaces above */
--WITH 
--    member AS (
--        SELECT
--                COUNT(*) AS total_members, 
--                pea.personcenter AS center_id 
--        FROM lifetime.person_ext_attrs pea
--        WHERE
--        pea.name = 'MMSRegistrationCategory'
--        AND pea.txtvalue = 'Member'            
--        group by pea.personcenter
--    ),     
