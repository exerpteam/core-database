...
--  
	...
	p.firstname AS FIRTSNAME,
	p.lastname AS LASTNAME,
	pea_mobile.txtvalue AS PhoneMobile,
    DECODE (p.STATUS, 0,'LEAD', 1,'ACTIVE', 2,'INACTIVE', 3,'TEMPORARYINACTIVE', 4,'TRANSFERED', 5,'DUPLICATE', 6,'PROSPECT', 8, 'ANONYMIZED', 9, 'CONTACT', 'UNKNOWN') AS Current_Status,
...
WHERE
	...
	p2.firstname AS FIRTSNAME,
	p2.lastname AS LASTNAME,
	 pea_mobile2.txtvalue AS PhoneMobile,
    DECODE (p2.STATUS, 0,'LEAD', 1,'ACTIVE', 2,'INACTIVE', 3,'TEMPORARYINACTIVE', 4,'TRANSFERED', 5,'DUPLICATE', 6,'PROSPECT', 8, 'ANONYMIZED', 9, 'CONTACT', 'UNKNOWN') AS Current_Status,
