...
CASE 
WHEN P.LAST_ACTIVE_START_DATE IS NULL THEN 0 
WHEN P.LAST_ACTIVE_END_DATE IS NULL THEN TRUNC(TO_DATE('2017-08-14', 'YYYY-MM-DD') - P.LAST_ACTIVE_START_DATE) + 1 ELSE P.MEMBERDAYS END AS UNBROKEN_MEMBER_DAYS, 
CASE WHEN P.LAST_ACTIVE_END_DATE IS NULL THEN TRUNC(TO_DATE('2017-08-14', 'YYYY-MM-DD') - P.LAST_ACTIVE_START_DATE) + 1 + P.ACCUMULATED_MEMBERDAYS ELSE P.MEMBERDAYS + P.MEMBERDAYS END AS BROKEN_MEMBER_DAYS, 
...
EI4.IDENTITY AS PIN 
    ...
    join PERSON_EXT_ATTRS PEA3 ON (PEA3.PERSONCENTER = 
        ...
        AND PEA3.NAME = '_eClub_Email')  WHERE P.CENTER IN (:scope)
