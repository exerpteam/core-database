...
WITH
    ...
    (
        SELECT
                TO_CHAR(ADD_MONTHS((date_trunc('MONTH',to_date(getcentertime(100), 'YYYY-MM-DD HH24:MI')) + INTERVAL '1 MONTH - 1 day')::date +1, -2),'YYYY-MM-DD') AS periodFrom,
                TO_CHAR(date_trunc('MONTH',to_date(getcentertime(100), 'YYYY-MM-DD HH24:MI'))::date-1,'YYYY-MM-DD') AS periodTo,
                datetolongTZ(TO_CHAR(ADD_MONTHS((date_trunc('MONTH',to_date(getcentertime(100), 'YYYY-MM-DD HH24:MI')) + INTERVAL '1 MONTH - 1 day')::date +1, -2), 'YYYY-MM-DD HH24:MI'),'Europe/Stockholm') AS periodFromLong,
                datetolongTZ(TO_CHAR((date_trunc('MONTH',to_date(getcentertime(100), 'YYYY-MM-DD HH24:MI'))::date), 'YYYY-MM-DD HH24:MI'),'Europe/Stockholm') AS periodToLong,
