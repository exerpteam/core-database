SELECT
    TO_CHAR(TRUNC(ADD_MONTHS((LAST_DAY(SYSDATE)+1),-2)),'YYYY-MM-DD') PERIOD_FROM ,
    TO_CHAR(TRUNC(ADD_MONTHS((LAST_DAY(SYSDATE)),-1)),'YYYY-MM-DD')   period_to ,
    i2.center_name ,
    i2.TODAY ,
    i2.COMPANY_NAME ,
    i2.ADDRESS1 ,
    ...
    i1.type ,
    i1.trans_id,
    i1.SALES_CENTER || TO_CHAR(SYSDATE,'YYYYMM')       INV_ID,
    TO_CHAR(TRUNC(add_months(SYSDATE,1)),'YYYY-MM-DD') DUE_DATE ,
    i2.ACCOUNT_NUMBER,
    i2.VAT AS VAT,
    i2.ORG_NBR,
    i2.BILLING_NBR,
    ...
    (
        ...
        WHERE
            (
                ...
                AND INV0.ENTRY_TIME >= 1496268000000
                AND INV0.ENTRY_TIME < 1498860000000 )
        GROUP BY
        ...
        WHERE
            (
                ...
                AND CN.ENTRY_TIME >= 1496268000000
                AND CN.ENTRY_TIME < 1498860000000 )
        GROUP BY
...
JOIN
    (
        ...
        WHERE
            p.LASTNAME LIKE '9' || REPLACE(lpad(21,3),' ','0') || ' %') i2
ON
    1 = 1
WHERE
    ( (
