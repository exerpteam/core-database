SELECT
	...
	CASE e.IDMETHOD  WHEN 1 THEN  'BARCODE'  WHEN 2 THEN  'MAGNETIC_CARD'  WHEN 3 THEN  'SSN'  WHEN 4 THEN  'RFID_CARD'  WHEN 5 THEN  'MEMBER_ID' ELSE 'UNKNOWN' END as "Membercard type",
	e.IDENTITY AS "Membercard ID"
