...
WHERE
	...
	AND i.TRANS_TIME < params.toDate -- yesterday at midnight +24 hours in ms
-- ROUND round to nearest..
--	AND i.TRANS_TIME >= datetolong(TO_CHAR(ROUND(current_timestamp -2), 'YYYY-MM-DD HH24:MI')) -- yesterday at midnight
--	AND i.TRANS_TIME < datetolong(TO_CHAR(ROUND(current_timestamp -2), 'YYYY-MM-DD HH24:MI')) + 86399*1000 -- yesterday at midnight +24 hours in ms
...
WHERE
	c.CENTER IN (:Scope)
	AND 
	c.TRANS_TIME >= params.fromDate -- yesterday at midnight
