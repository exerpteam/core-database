...
-- https://clublead.atlassian.net/browse/ST-4200
/**
* Creator: Exerp
* ServiceTicket: ST-4200
* Purpose: List detailed usage of campaigncodes. Should display what campaign and used by who.
*/
SELECT
    cen.NAME AS CENTER,
    table1.*
