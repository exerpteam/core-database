...
FROM
    (
        ...
        WHERE
			...
			AND act.TRANS_TIME >= datetolong(TO_CHAR(ROUND(exerpsysdate() -2), 'YYYY-MM-DD HH24:MI'))
			AND act.TRANS_TIME < datetolong(TO_CHAR(ROUND(exerpsysdate() + 2), 'YYYY-MM-DD HH24:MI'))
    )
    payments
JOIN
    ...
    (
        ...
        WHERE
			...
			-- i.ENTRY_TIME > (datetolong(TO_CHAR(ROUND(exerpsysdate() - 1), 'YYYY-MM-DD HH24:MI')) - 1000*60*60*24*180)
			i.ENTRY_TIME >= datetolong(TO_CHAR(ROUND(exerpsysdate() - 180), 'YYYY-MM-DD HH24:MI'))
        ...
        WHERE
			...
			-- c.ENTRY_TIME > (datetolong(TO_CHAR(ROUND(exerpsysdate() - 1), 'YYYY-MM-DD HH24:MI')) - 1000*60*60*24*180)
			c.ENTRY_TIME >= datetolong(TO_CHAR(ROUND(exerpsysdate() - 180), 'YYYY-MM-DD HH24:MI'))
