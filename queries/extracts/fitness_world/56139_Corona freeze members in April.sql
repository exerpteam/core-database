...
-- https://clublead.atlassian.net/browse/ST-11030
WITH
    sub AS
    (
        SELECT
            ...
            CASE
                WHEN existsrd.start_date IS NULL
                THEN NULL
                WHEN (existsrd.start_date > to_date('01-04-2020', 'dd-MM-yyyy')
                        OR existsrd.end_date < to_date('16-04-2020', 'dd-MM-yyyy'))
                THEN 'NO'
                ELSE 'YES'
            END                                               FULLPERIODFREEZE,
        ...
        ON
            ...
            AND existsrd.end_date >= to_date('01-04-2020', 'dd-MM-yyyy')
        ...
        ON
            ...
            AND (
                sa.end_date IS NULL
                OR sa.end_date >= to_date('12-03-2020', 'dd-MM-yyyy'))
        LEFT JOIN
        ...
        WHERE
            ...
            AND s.state IN (2,
                            4,
                            8)
            /* Freeze in April overlap period 01/04 - 16/04 and excluded created by update script*/
            AND existsrd.id IS NOT NULL
