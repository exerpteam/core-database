...
8,'GUEST','UNKNOWN') AS PERSON_TYPE,
    ...
    SUBSCRIPTION_SALES.TERMINATION_DATE as last_edit_time,
CANCELLATION_EMPLOYEE_CENTER ||'emp'|| SUBSCRIPTION_SALES.CANCELLATION_EMPLOYEE_ID as employee_termination,
Subscriptions.REASSIGNED_CENTER
FROM 
    Subscriptions 
JOIN 
    persons 
...
left JOIN 
    SUBSCRIPTION_SALES 
    ON 
    Subscriptions.center = SUBSCRIPTION_SALES.SUBSCRIPTION_CENTER 
    AND Subscriptions.id = SUBSCRIPTION_SALES.SUBSCRIPTION_ID 
LEFT JOIN 
