...
-- https://clublead.atlassian.net/browse/ST-11029
WITH
    sub AS
    (
        SELECT
            ...
            CASE
                ...
                THEN NULL
                WHEN (existsrd.start_date > to_date('12-03-2020', 'dd-MM-yyyy')
                        OR existsrd.end_date < to_date('27-03-2020', 'dd-MM-yyyy'))
                THEN 'NO'
                ELSE 'YES'
        ...
        ON
            ...
            AND existsrd.start_date <= to_date('27-03-2020', 'dd-MM-yyyy')
        ...
        WHERE
            ...
            AND s.state IN (2,
                            4,
                            8)
            /* Freeze in March overlap period 12/03 - 27/03*/
