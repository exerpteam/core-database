...
-- https://clublead.atlassian.net/browse/ST-11031
WITH
    sub AS
    (
        SELECT
        ...
        WHERE
            ...
            AND s.state IN (2,
                            4,
                            8)
            /* Include subscription ended btween 13th March and 16th April*/
            AND s.end_date BETWEEN to_date('13-03-2020', 'dd-MM-yyyy') AND to_date('16-04-2020', 'dd-MM-yyyy')
    )
    ,
    v_pivot AS
    (
