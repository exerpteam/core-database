...
SELECT DISTINCT
    ...
    prod.GLOBALID,
    pac.NAME,
    sales_acc.GLOBALID sales_acc_GLOBALID,
    ...
    expenses_acc.GLOBALID expenses_acc_GLOBALID,
    ...
    refund_acc.GLOBALID refund_acc_GLOBALID,
    ...
    write_off_acc.GLOBALID write_off_acc_GLOBALID,
