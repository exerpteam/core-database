...
SELECT
    ...
    exerpro.longtodate(sp.ENTRY_TIME)                                                      AS "Price Change: EntryTime",
    sp.PRICE                                                                               AS "New Price",
...
WHERE
sp.FROM_DATE = to_date('2016-03-01', 'yyyy-MM-dd')
and sp.PRICE = '249'
and sp.CANCELLED = 1
and products.name = 'Fitness og Hold (gl)'
