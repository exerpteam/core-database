...
AND prod.name IN ('Fri træning - 14 dage',
'Værdikupon - 2 ugers gratis træning',
'PROMO – 14 dages fri træning',
'Værdikupon - 1 uges gratis træning',
'14 dages fri træning - Slut med forbudt',
'Værdikupon - 1 måneds gratis træning',
'FLYER - 7 dages fri træning',
'14 dages træning')
