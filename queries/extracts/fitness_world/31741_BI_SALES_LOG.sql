...
WHERE
    i.ENTRY_TIME BETWEEN CAST(datetolong(TO_CHAR(CURRENT_DATE - interval '1 day'*$$offset$$ ,
    'yyyy-MM-dd HH24:MI')) AS BIGINT) AND CAST(datetolong(TO_CHAR(CURRENT_DATE + interval '1 day',
...
AND cpayer.ID = payer.TRANSFERS_CURRENT_PRS_ID
WHERE
    c.ENTRY_TIME BETWEEN CAST(datetolong(TO_CHAR(CURRENT_DATE - interval '1 day'*$$offset$$ ,
    'yyyy-MM-dd HH24:MI')) AS BIGINT) AND CAST(datetolong(TO_CHAR(CURRENT_DATE + interval '1 day',
    'yyyy-MM-dd HH24:MI')) AS BIGINT)
