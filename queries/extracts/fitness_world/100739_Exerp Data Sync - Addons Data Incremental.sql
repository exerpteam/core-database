...
--  
 WITH
    ...
    (
     SELECT
       datetolongTZ(TO_CHAR(date_trunc('day',CURRENT_TIMESTAMP-INTERVAL '10 days'), 'YYYY-MM-DD HH24:MI'), 'Europe/Zurich')::bigint AS FROMDATE,
         datetolongTZ(TO_CHAR(date_trunc('day',CURRENT_TIMESTAMP+ INTERVAL '1 day'), 'YYYY-MM-DD HH24:MI'), 'Europe/Zurich')::bigint AS TODATE
 ...
 SELECT
	 ...
	 TO_CHAR(COALESCE(round(sa.INDIVIDUAL_PRICE_PER_UNIT,2)*sa.QUANTITY, 0), 'FM999999990.00') AS "PRICE",
