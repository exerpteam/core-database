...
(
    SELECT EXTERNAL_ID
    FROM Persons 
    WHERE EXTERNAL_ID IN ('2260856', '1613880', '1329619', '2103679', '1525693', '845429', '2414262', '592459', '1939112', '11649', '1550744', '441702', '2063989', '1586986', '2216808', '1490720', '1962970', '2333249', '1625373', '1097650', '1545487', '319090', '1528301', '1826314', '1954830', '1674618', '520058', '488732', '640189', '1647826', '2186138', '1600579', '123878', '473982', '739579', '1470188', '85031', '2515178', '2443639', '1037990', '2255334', '2569416', '1683183', '566459', '779365', '2230769', '2395799', '1906312', '2493323', '2151202', '2026172', '1918895', '1091338', '361841', '15898', '1986598', '862983', '1569494', '1755134', '2257969', '2491771', '1524817', 
'213225', '1512179', '2047600', '1083216', '29773', '1751606', '2539184', '1559072', '66774', '103554', '2044155', '2052832', '592772', '1036496', '210316', '1414874', '1289469', '717692', '2479650', '1489174', '1797298', '2190529', '2395070', '111978', '1596821', '680614', '1005545', '1903424', '748658', '1916972', '1703637', '1639997', '308377', '605968', '335431', '2214248', '401528')
)
SELECT
    "MEMBERNO",
    "PCENTER",
    ...
    "PERSONSTATUS",
    "BLACKLISTED",
    TO_CHAR(longtodateTZ(j.creation_time, 'Europe/Zurich'), 'YYYY-MM-DD HH24:MI:SS') AS
    "BLACKLISTSTARTDATE",
    "MEMBERDAYS",
    ...
    "MEMBERSINCEDATE",
    TO_CHAR(longtodateTZ(pea.APPLOGIN_LAST_EDIT_TIME, 'Europe/Zurich'),
    ...
    CASE pea.AEM_TXTVALUE
        ...
        ELSE 0
    END                                                                 AS "EMAILOPTIN",
    TO_CHAR(longtodateTZ(pea.AEM_LAST_EDIT_TIME, 'Europe/Zurich'),'YYYY-MM-DD HH24:MI:SS') AS
    "EMAILOPTINDATE",
    ...
    TO_CHAR(longtodatetz(last_person_status.LastTime,'Europe/Zurich'),'YYYY-MM-DD') AS
                         "PERSONSTATUSLASTMODIFIEDDATE",
    TO_CHAR(longtodatetz(pea.ANL_LAST_EDIT_TIME,'Europe/Zurich'),'YYYY-MM-DD HH24:MI:SS') AS
    "NEWSLETTEROPTINDATE",
    ...
    TO_CHAR(longtodatetz(pea.PUSHNOTIFY_LAST_EDIT_TIME,'Europe/Zurich'),
    ...
    CASE pea.SMSMARKET_TXTVALUE
        ...
        ELSE 0
    END AS "SMSMARKETING",
    TO_CHAR(longtodatetz(pea.SMSMARKET_LAST_EDIT_TIME,'Europe/Zurich'),
    ...
    TO_CHAR(longtodatetz(pea.SOCIALMEDIA_LAST_EDIT_TIME,'Europe/Zurich'),
    ...
    CASE pea.ALLOWSURVEY_TXTVALUE
        ...
        ELSE 0
    END AS "ALLOWSURVEY",
    TO_CHAR (longtodatetz (pea.ALLOWSURVEY_LAST_EDIT_TIME, 'Europe/Zurich'),
...
FROM
    (
        SELECT
            ...
            TO_CHAR(longtodatetz(p.LAST_MODIFIED,'Europe/Zurich'),'YYYY-MM-DD HH24:MI:SS') AS
            "EXERPLASTMODIFIEDDATE"
        FROM
            persons p
        INNER JOIN
            params 
        ON p.EXTERNAL_ID = params.EXTERNAL_ID
        LEFT JOIN
            ENTITYIDENTIFIERS e
        ON
            e.IDMETHOD = 5
...
LEFT JOIN
    (
        SELECT
            ...
            MAX(
                CASE
                    WHEN name = '_eClub_LanguagePreferred'
                    THEN TXTVALUE
                    ELSE NULL
                END) AS LANGUAGE_TXTVALUE,
            MAX(
                CASE
