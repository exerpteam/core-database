...
and art.text not in ('Transfer between accounts') and art.amount > 0
and (longtodate(art.entry_time) between t1.req_date-1 and t1.req_date+1)

--and ccr.REQ_DELIVERY = 89203