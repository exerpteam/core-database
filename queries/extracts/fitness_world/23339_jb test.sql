...
SELECT
    ...
    CAMPAIGNNAME as campaign_source_name,
    longtodateC(CAMPAIGNEND, centerid) as campaign_signup_enddate
FROM
    (
        SELECT
        ...
        FROM
            (
                SELECT
                    ...
                    sc_area.name as campaign_name,
                    sc_area.endtime as campaign_end
                ...
                SELECT
                    ...
                    sc_center.name as campaign_name,
                    sc_center.endtime as campaign_end
                FROM
                    centers c
                LEFT JOIN
        ...
        FROM
            (
                SELECT
                    ...
                    pr_area.name as campaign_name,
                    pr_area.endtime as campaign_end
                FROM
                    centers c
                JOIN
                    TEMP_TABLE tt
                ...
                SELECT
                    ...
                    pr_center.name as campaign_name,
                    pr_center.endtime as campaign_end
                FROM
                    centers c
                LEFT JOIN
