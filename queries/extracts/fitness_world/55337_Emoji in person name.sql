...
SELECT
    ...
    CASE  per.STATUS  WHEN 0 THEN 'LEAD'  WHEN 1 THEN 'ACTIVE'  WHEN 2 THEN 'INACTIVE'  WHEN 3 THEN 'TEMPORARYINACTIVE'  WHEN 4 THEN 'TRANSFERRED'  WHEN 5 THEN 
...
WHERE
    per.STATUS in (1,3)
AND (NOT (FIRSTNAME ~ '[[:alpha:] 0-9\-.]') 
OR NOT (LASTNAME ~ '[[:alpha:] 0-9\-.]'))
