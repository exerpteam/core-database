...
(
        SELECT
                ...
                dateToLongC(TO_CHAR(MAKE_DATE(FromYear,FromMonth+1, 1),'YYYY-MM-DD'),t1.center_id)-1 AS toDateLong,
                MAKE_DATE(FromYear,FromMonth, 1) AS fromDate,
                MAKE_DATE(FromYear,FromMonth+1, 1) - interval '1 days' AS toDate,
...
SELECT DISTINCT p.center||'p'||p.id,
