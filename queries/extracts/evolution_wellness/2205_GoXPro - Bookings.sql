...
(
        ...
        SELECT 
                ...
                CASE 
                        WHEN b.class_capacity IS NULL THEN 0
                        ELSE b.class_capacity
                END AS "Max Client Quantity",
        ...
        WHERE
                ...
                --AND pa.state NOT IN ('CANCELLED')
                AND b.starttime > par.cutDate    
                AND a.activity_type = 4
				AND b.class_capacity > 0
) t1
WHERE ranking = 1