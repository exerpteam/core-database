...
(
        SELECT 
                ...
                apd.INCLUDE_HOME_CENTER AS ao_include_home_center,
                apd.REQUIRED AS ao_main_requires_addon,
                apd.USE_INDIVIDUAL_PRICE AS ao_USE_dynamic_price,
                apd.INCLUDE_IN_PRO_RATA_PERIOD AS AO_AVAILABLE_IN_PRO_RATA_PER,
                apd.BINDING_PERIOD_COUNT AS ao_BINDING_PERIOD_COUNT,
                (CASE apd.BINDING_PERIOD_UNIT
                        ...
                        WHEN 6 THEN 'SECOND'
                        ELSE 'UNDEFINED'
                END) AS ao_binding_period_unit,
                aoSubProd.CACHED_PRODUCTNAME AS AO_REQUIRED_SUBS_NAMES,
                addReqPG.NAME AS AO_REQUIRED_PGROUPS_NAMES,
                aoFreezePROD.NAME AS AO_FREE_PROD_NAME,
                ...
                (CASE st.st_type
                        WHEN 0 THEN 'Cash'
                        WHEN 1 THEN 'EFT'
                        WHEN 2 THEN 'Recurring clipcard)'
                        WHEN 3 THEN 'Course'
