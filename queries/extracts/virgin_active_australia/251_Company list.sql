...
SELECT DISTINCT
    ...
    ca.ref AS "Company Agreement Ref",
    CASE
        WHEN ca.STATE = 0
        THEN 'Under target'
        WHEN ca.STATE = 1
    ...
    (
        CASE
            WHEN DATE_TRUNC('MONTH',FROM_DATE)= FROM_DATE
            AND (FROM_DATE + INTERVAL '1 MONTH' - INTERVAL '1 day') = TO_DATE
