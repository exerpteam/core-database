...
AND prod.name not in ('Toddlz','Club V 3-12', 'Club V 13-15')
    AND NOT EXISTS (
        ...
        JOIN PRODUCTS oldsubprod ON oldsubprod.CENTER = oldsub.subscriptiontype_center AND oldsubprod.ID = oldsub.subscriptiontype_id AND oldsubprod.name NOT IN ('Free Adult Guest', 'Paying Adult Guest','Trial Membership', 'Guest', 'Guest Pass Subscripion','Online Membership','Hyrox Training','Invite A Friend')
