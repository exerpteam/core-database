...
-- List of all subscriptions configured in Exerp
...
(
        ...
        (
                ...
                SELECT 
                        ...
                        UNNEST(xpath('//subscriptionType/priceUpdateExcluded/text()', px.pxml))::text AS price_update_excluded,
                        (cast (UNNEST(xpath('//subscriptionType/useIndividualPrice/text()', px.pxml)) as text) != 'true')::text AS use_dynamic_price,
