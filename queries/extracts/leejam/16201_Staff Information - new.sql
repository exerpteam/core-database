...
SELECT 
        ...
        END AS "Role"
        ,longtodatec(emp.created_at,emp.center) AS created_date
        ,CASE
                WHEN emp.blocked = false THEN NULL
                ELSE longtodatec(emp.block_status_changed_at,emp.center) 
        END AS blocked_date
        ,CASE
                WHEN emp.blocked = true THEN NULL
                ELSE longtodatec(emp.block_status_changed_at,emp.center) 
        END AS unblocked_date
FROM
