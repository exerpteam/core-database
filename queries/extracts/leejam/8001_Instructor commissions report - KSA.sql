...
SELECT DISTINCT
    ...
    CASE
        WHEN acs.staff_group_id = 201
        THEN person_salary.salary
...
LEFT JOIN
    person_salary
ON
    person_salary.center_id = part.center
...
and (ac.activity_type in (4) or ac.activity_type in (2) and ac.id in (203,1401,1601,1,2))
